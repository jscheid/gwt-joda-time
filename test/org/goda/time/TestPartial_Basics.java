 ...
 */
public class TestPartial_Basics extends GWTTestCase {
  @Override
  ...
  private Partial createHourMinPartial(int hour, int min, Chronology chrono) {
    return new Partial(new DateTimeFieldType[] {DateTimeFieldType.hourOfDay(), DateTimeFieldType.minuteOfHour()}, new int[] {hour, min},
        chrono);
  }
  ...
  private Partial createTODPartial(Chronology chrono) {
    return new Partial(new DateTimeFieldType[] {
        ...
        DateTimeFieldType.millisOfSecond()}, new int[] {10, 20, 30, 40}, chrono);
  }
