 ...
 */
public class TestMutableDateTime_Basics extends GWTTestCase {
  @Override
  ...
  public void testEqualsHashCode() {
    ...
    assertEquals(true, new MutableDateTime(TEST_TIME1, new MockEqualsChronology()).equals(new MutableDateTime(TEST_TIME1,
        new MockEqualsChronology())));
    assertEquals(false, new MutableDateTime(TEST_TIME1, new MockEqualsChronology()).equals(new MutableDateTime(TEST_TIME1,
