...
import org.goda.time.field.DelegatedDurationField;
 ...
 */
public class TestSerialization extends GWTTestCase {
  @Override
  ...
  public void testSerializedUnsupportedDateTimeField() throws Exception {
    UnsupportedDateTimeField test = UnsupportedDateTimeField.getInstance(DateTimeFieldType.year(),
