...
import org.goda.time.base.AbstractInterval;
...
import org.goda.time.chrono.LenientChronology;
 ...
 */
public class TestInterval_Basics extends GWTTestCase {
  @Override
  ...
  protected void gwtSetUp() throws Exception {
    ...
    TimeZone tz = TimeZone.getTimeZone(PARIS.getID());
  ...
  public void testEqualsHashCodeLenient() {
    Interval test1 = new Interval(new DateTime(TEST_TIME1, LenientChronology.getInstance(COPTIC_PARIS)), new DateTime(TEST_TIME2,
        LenientChronology.getInstance(COPTIC_PARIS)));
    Interval test2 = new Interval(new DateTime(TEST_TIME1, LenientChronology.getInstance(COPTIC_PARIS)), new DateTime(TEST_TIME2,
        LenientChronology.getInstance(COPTIC_PARIS)));
    assertEquals(true, test1.equals(test2));
    assertEquals(true, test2.equals(test1));
    assertEquals(true, test1.equals(test1));
