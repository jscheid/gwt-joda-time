 ...
 */
public class TestOffsetDateTimeField extends GWTTestCase {
  @Override
  ...
  public void test_constructor1() {
    ...
    try {
      field = new OffsetDateTimeField(UnsupportedDateTimeField.getInstance(DateTimeFieldType.secondOfMinute(),
          UnsupportedDurationField.getInstance(DurationFieldType.seconds())), 0);
      fail();
    } catch (IllegalArgumentException ex) {
    }
  }
