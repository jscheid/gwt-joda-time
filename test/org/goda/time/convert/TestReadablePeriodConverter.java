 ...
 */
public class TestReadablePeriodConverter extends GWTTestCase {
  @Override
  ...
  public void testGetPeriodType_Object() throws Exception {
    ...
    assertEquals(PeriodType.yearMonthDayTime(), ReadablePeriodConverter.INSTANCE.getPeriodType(new Period(123L,
