 ...
 */
public class TestISODateTimeFormat extends GWTTestCase {
  @Override
  ...
  public void testFormat_date_partial() {
    Partial dt = new Partial(new DateTimeFieldType[] {
        DateTimeFieldType.year(), DateTimeFieldType.monthOfYear(), DateTimeFieldType.dayOfMonth()}, new int[] {2004, 6, 9});
    assertEquals("2004-06-09", ISODateTimeFormat.date().print(dt));
  }
  ...
  public void testFormat_time_partial() {
    Partial dt = new Partial(new DateTimeFieldType[] {
        ...
        DateTimeFieldType.millisOfSecond()}, new int[] {10, 20, 30, 40});
