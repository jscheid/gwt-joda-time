...
import org.goda.time.format.PeriodFormat;
 ...
 */
public class TestPeriod_Basics extends GWTTestCase {
  @Override
  ...
  public void testTypeIndexMethods() {
    ...
    assertEquals(true, Arrays.equals(new DurationFieldType[] {
        ...
        DurationFieldType.seconds(), DurationFieldType.millis()}, test.getFieldTypes()));
  }
