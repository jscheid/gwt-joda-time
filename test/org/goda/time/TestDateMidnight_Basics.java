 ...
 */
public class TestDateMidnight_Basics extends GWTTestCase {
  @Override
  ...
  // 2002-04-05
  private long TEST_TIME1_UTC = (y2002days + 31L + 28L + 31L + 5L - 1L) * DateTimeConstants.MILLIS_PER_DAY + 12L
  ...
  private long TEST_TIME1_PARIS = (y2002days + 31L + 28L + 31L + 5L - 1L) * DateTimeConstants.MILLIS_PER_DAY - 2
      * DateTimeConstants.MILLIS_PER_HOUR;

  // 2003-05-06
  private long TEST_TIME2_UTC = (y2003days + 31L + 28L + 31L + 30L + 6L - 1L) * DateTimeConstants.MILLIS_PER_DAY + 14L
  ...
  private long TEST_TIME2_LONDON = (y2003days + 31L + 28L + 31L + 30L + 6L - 1L) * DateTimeConstants.MILLIS_PER_DAY
      - DateTimeConstants.MILLIS_PER_HOUR;
  private long TEST_TIME2_PARIS = (y2003days + 31L + 28L + 31L + 30L + 6L - 1L) * DateTimeConstants.MILLIS_PER_DAY - 2
      * DateTimeConstants.MILLIS_PER_HOUR;
  ...
  //    public void testToCalendar_Locale() {      //FIXME fix this test
  //        DateMidnight test = new DateMidnight(TEST_TIME1_UTC);
  ...
  //    }
  //
  //    public void testToGregorianCalendar() {      //FIXME fix this test
  //        DateMidnight test = new DateMidnight(TEST_TIME1_UTC);
