 ...
 * <p>
 * <code>Weeks</code> is an immutable period that can only store weeks. It does
 * not store years, months or hours for example. As such it is a type-safe way
 * of representing a number of weeks in an application.
 * <p>
...
public final class Weeks extends BaseSingleFieldPeriod {
  ...
  /**
   * Constant representing the maximum number of weeks that can be stored in
   * this object.
   */
  public static final Weeks MAX_VALUE = new Weeks(Integer.MAX_VALUE);
  /**
   * Constant representing the minimum number of weeks that can be stored in
   * this object.
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a <code>Weeks</code> representing the number of whole weeks between
   * the two specified datetimes.
  ...
  /**
   * Creates a <code>Weeks</code> representing the number of whole weeks in the
   * specified interval.
   ...
   * the weeks component may be non-zero. If any other component is non-zero, an
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new instance representing a number of weeks. You should consider
   * using the factory method {@link #weeks(int)} instead of the constructor.
  ...
  /**
   * Converts this period in weeks to a period in hours assuming a 7 day week
   * and 24 hour day.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all weeks are 7 days
   * long and all days are 24 hours long. This is not true when daylight savings
  ...
  /**
   * Converts this period in weeks to a period in minutes assuming a 7 day week,
  ...
  /**
   * Converts this period in weeks to a period in seconds assuming a 7 day week,
   * 24 hour day, 60 minute hour and 60 second minute.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all weeks are 7 days
   * long, all days are 24 hours long, all hours are 60 minutes long and all
   * minutes are 60 seconds long. This is not true when daylight savings is
   * considered and may also not be true for some unusual chronologies. However,
   ...
   * week, 24 hour day, 60 minute hour and 60 second minute.
   * <p>
   * This method allows you to convert from a period to a duration. However to
   * achieve this it makes the assumption that all weeks are 7 days long, all
   * days are 24 hours long, all hours are 60 minutes long and all minutes are
   * 60 seconds long. This is not true when daylight savings time is considered,
  ...
  /**
   * Returns a new instance with the weeks divided by the specified divisor. The
   * calculation uses integer division, thus 3 divided by 2 is 1.
   * <p>
   * This instance is immutable and unaffected by this method call.
