...
public final class Months extends BaseSingleFieldPeriod {
   ...
   * between the two specified datetimes. This method corectly handles any
   ...
   * the specified interval. This method corectly handles any daylight savings
   ...
   * the months component may be non-zero. If any other component is non-zero,
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new instance representing a number of months. You should consider
   * using the factory method {@link #months(int)} instead of the constructor.
