...
public final class Hours extends BaseSingleFieldPeriod {
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a <code>Hours</code> representing the number of whole hours between
  ...
  /**
   * Creates a <code>Hours</code> representing the number of whole hours in the
   * specified interval.
   ...
   * the hours component may be non-zero. If any other component is non-zero, an
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new instance representing a number of hours. You should consider
   * using the factory method {@link #hours(int)} instead of the constructor.
   ...
   * time is considered, and may also not be true for some unusual chronologies.
   ...
   * long. This is not true when daylight savings time is considered, and may
   ...
   * achieve this it makes the assumption that all hours are 60 minutes and all
   * minutes are 60 seconds. This might not be true for an unusual chronology,
   * for example one that takes leap seconds into account. However, the method
   * is included as it is a useful operation for many applications and business
   * rules.
  ...
  /**
   * Returns a new instance with the hours divided by the specified divisor. The
