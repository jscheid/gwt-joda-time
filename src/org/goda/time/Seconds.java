 ...
 * <p>
 * <code>Seconds</code> is an immutable period that can only store seconds. It
 * does not store years, months or hours for example. As such it is a type-safe
 * way of representing a number of seconds in an application.
 * <p>
...
public final class Seconds extends BaseSingleFieldPeriod {
  ...
  /**
   * Creates a <code>Seconds</code> representing the number of whole seconds in
  ...
  /**
   * Creates a new <code>Seconds</code> by parsing a string in the ISO8601
   * format 'PTnS'.
   * <p>
   * The parse will accept the full ISO syntax of PnYnMnWnDTnHnMnS however only
   * the seconds component may be non-zero. If any other component is non-zero,
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new instance representing a number of seconds. You should
   * consider using the factory method {@link #seconds(int)} instead of the
   * constructor.
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this period in seconds to a period in weeks assuming a 7 day week,
   ...
   * minutes are 60 seconds long. This is not true when daylight savings time is
  ...
  /**
   * Converts this period in seconds to a period in days assuming a 24 hour day,
   ...
   * This is not true when daylight savings is considered and may also not be
  ...
  /**
   * Converts this period in seconds to a period in hours assuming a 60 minute
   * hour and 60 second minute.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all hours are 60
   * minutes long and all minutes are 60 seconds long. This may not be true for
  ...
  /**
   * Converts this period in seconds to a period in minutes assuming a 60 second
   * minute.
   * <p>
   * This method allows you to convert between different types of period.
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this period in seconds to a duration in milliseconds assuming a 24
   * hour day, 60 minute hour and 60 second minute.
   * <p>
   * This method allows you to convert from a period to a duration. However to
   * achieve this it makes the assumption that all seconds are 24 hours long,
   * all hours are 60 minutes and all minutes are 60 seconds. This is not true
   * when daylight savings time is considered, and may also not be true for some
   * unusual chronologies. However, it is included as it is a useful operation
   ...
   * <p>
   * This instance is immutable and unaffected by this method call.
   * @param seconds the amount of seconds to add, may be negative, null means
   *          zero
   * @return the new period plus the specified number of seconds
   * @throws ArithmeticException if the result overflows an int
   */
