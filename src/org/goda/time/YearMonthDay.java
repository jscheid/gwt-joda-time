...
public final class YearMonthDay extends BasePartial implements ReadablePartial, Serializable {
   ...
   * YearMonthDay with ISO chronology. It is expected that you will only pass in
  ...
  //    }
  /**
   * Constructs a YearMonthDay from a <code>java.util.Date</code> using exactly
   * the same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Date and assigned to the YearMonthDay. This
   * is useful if you have been using the Date as a local date, ignoing the
   * zone.
   * <p>
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a YearMonthDay with the current date, using ISOChronology in the
   ...
   * described by {@link ISODateTimeFormat#dateOptionalTimeParser()}.
   * <p>
  ...
  //-----------------------------------------------------------------------
  /**
   * Returns a copy of this date with the specified chronology. This instance is
  ...
  public YearMonthDay withChronologyRetainFields(Chronology newChronology) {
    ...
    if (newChronology == getChronology()) {
      ...
      newChronology.valDateTime(newYearMonthDay, getValues());
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this YearMonthDay to a full datetime at midnight using the default
   * time zone.
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this object to a DateTime using a TimeOfDay to fill in the missing
   * fields and using the default time zone. This instance is immutable and
   ...
   * fields. This instance is immutable and unaffected by this method call.
   * <p>
   * The resulting chronology is determined by the chronology of this
   * YearMonthDay plus the time zone. The chronology of the time is ignored -
   * only the field values are used.
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new YearMonthDay with this field set to the maximum value for
     * this field.
     * <p>
    ...
    /**
     * Returns a new YearMonthDay with this field set to the minimum value for
     * this field.
     * <p>
     * The YearMonthDay attached to this property is unchanged by this call.
