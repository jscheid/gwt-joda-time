...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a LocalDate from a <code>java.util.Calendar</code> using exactly
   * the same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Calendar and assigned to the LocalDate. This
   * is useful if you have been using the Calendar as a local date, ignoing the
   * zone.
   * <p>
  ...
  //    }
  /**
   * Constructs a LocalDate from a <code>java.util.Date</code> using exactly the
   * same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Date and assigned to the LocalDate. This is
   * useful if you have been using the Date as a local date, ignoing the zone.
   * <p>
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs an instance from an Object that represents a datetime. The time
   * zone will be retrieved from the object if possible, otherwise the default
   ...
   * formats are described by {@link ISODateTimeFormat#localDateParser()}. The
   ...
   * fields are Year, MonthOfYear and DayOfMonth. Note that all fields from day
   * and above may in fact be queried via other methods.
   ...
   * interface. The supported fields are Year, MonthOfYear and DayOfMonth. Note
   * that all fields from day and above may in fact be queried via other
   * methods.
  ...
  /**
   * Converts this LocalDate to a full datetime at midnight using the specified
   * time zone.
   * <p>
   ...
   * date. The problem is that there is no such time as midnight on the required
   * date, and as such an exception is thrown.
   * <p>
   * This method uses the chronology from this instance plus the time zone
   * specified.
   * <p>
   ...
   * {@link #toDateTimeAtStartOfDay()} instead because of the exception detailed
   * below.
   * <p>
   * This method will throw an exception if the default time zone switches to
   * Daylight Savings Time at midnight and this LocalDate represents that
   ...
   * The chronology of the time must also match. If the time is null an
   * exception is thrown.
   * <p>
   * This instance is immutable and unaffected by this method call.
   ...
   * @throws IllegalArgumentException if the chronology of the time does not
   *           match
   * @since 1.5
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this object to a DateTime using a LocalTime to fill in the missing
   * fields and using the default time zone.
   * <p>
   * The resulting chronology is determined by the chronology of this LocalDate.
   * The chronology of the time must match. If the time is null, the current
   * time in the date's chronology is used.
   * <p>
   * This method will throw an exception if the datetime that would be created
   * does not exist when the time zone is taken into account.
   * <p>
   ...
   * <p>
   * The resulting chronology is determined by the chronology of this LocalDate
   * plus the time zone. The chronology of the time must match. If the time is
   * null, the current time in the date's chronology is used.
   * <p>
   * This method will throw an exception if the datetime that would be created
   * does not exist when the time zone is taken into account.
   * <p>
   ...
   * <p>
   * Unsupported time fields are ignored, thus adding a period of 24 hours will
   * not have any effect.
   ...
   * instances of LocalDate - they do not modify the original. The example below
   * yields two independent immutable date objects 20 years apart.
   * 
   * <pre>
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new LocalDate with this field set to the maximum value for this
     * field.
     * <p>
     * This operation is useful for obtaining a LocalDate on the last day of the
     * month, as month lengths vary.
     * 
     * <pre>
    ...
    /**
     * Returns a new LocalDate with this field set to the minimum value for this
     * field.
     * <p>
     * The LocalDate attached to this property is unchanged by this call.
     ...
     * LocalDate.
     * <p>
     * For example, rounding floor on the hourOfDay field of a LocalDate where
     * the time is 10:30 would result in new LocalDate with the time of 10:00.
     * @return a copy of the LocalDate with the field value changed
     */
     ...
     * <p>
     * For example, rounding floor on the hourOfDay field of a LocalDate where
     * the time is 10:30 would result in new LocalDate with the time of 11:00.
     * @return a copy of the LocalDate with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this
     * LocalDate. If halfway, the ceiling is favored over the floor only if it
