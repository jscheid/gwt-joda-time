...
public class IllegalFieldValueException extends IllegalArgumentException {
  ...
  private final DateTimeFieldType DateTimeTimeFieldType;
  ...
  public IllegalFieldValueException(DateTimeFieldType fieldType, Number value, Number lowerBound, Number upperBound) {
    ...
    DateTimeTimeFieldType = fieldType;
  ...
  /**
   * Returns the lower bound of the legal value range, or null if not
   * applicable.
  ...
  /**
   * Returns the upper bound of the legal value range, or null if not
   * applicable.
