 ...
 * <p>
 * LocalTime implements the {@link ReadablePartial} interface. To do this, the
 * interface methods focus on the key fields - HourOfDay, MinuteOfHour,
 * SecondOfMinute and MillisOfSecond. However, <b>all</b> time fields may in
 * fact be queried.
 * <p>
 * Calculations on LocalTime are performed using a {@link Chronology}. This
...
public final class LocalTime extends BaseLocal implements ReadablePartial, Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a LocalTime from the specified millis of day using the ISO
   * chronology.
   * <p>
  ...
  /**
   * Constructs a LocalTime from the specified millis of day using the specified
   * chronology.
   * <p>
   * The millisOfDay value may exceed the number of millis in one day, but
   * additional days will be ignored. This method uses the UTC time zone
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a LocalTime from a <code>java.util.Calendar</code> using exactly
   * the same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Calendar and assigned to the LocalTime. This
   * is useful if you have been using the Calendar as a local time, ignoing the
   * zone.
   * <p>
   * This factory method ignores the type of the calendar and always creates a
   * LocalTime with ISO chronology. It is expected that you will only pass in
   ...
   */
  /*
   * public static LocalTime fromCalendarFields(Calendar calendar) { if
   * (calendar == null) { throw new
   * IllegalArgumentException("The calendar must not be null"); } return new
   * LocalTime( calendar.get(Calendar.HOUR_OF_DAY),
   * calendar.get(Calendar.MINUTE), calendar.get(Calendar.SECOND),
   * calendar.get(Calendar.MILLISECOND) ); }
   */

  /**
   * Constructs a LocalTime from a <code>java.util.Date</code> using exactly the
   * same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Date and assigned to the LocalTime. This is
   * useful if you have been using the Date as a local time, ignoing the zone.
   * <p>
  ...
  public static LocalTime fromDateFields(Date date) {
    ...
    return new LocalTime(date.getHours(), date.getMinutes(), date.getSeconds(), (int) (date.getTime() % 1000));
  }
   ...
   * formats are described by {@link ISODateTimeFormat#localTimeParser()}. The
   ...
   * interface. The supported fields are HourOfDay, MinuteOfHour, SecondOfMinute
   * and MillisOfSecond.
  ...
  /**
   * Checks if the field type specified is supported by this local time and
  ...
  /**
   * Checks if the duration type specified is supported by this local time and
   * chronology.
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the local milliseconds from the Java epoch of 1970-01-01T00:00:00 (not
  ...
  //-----------------------------------------------------------------------
  /**
   * Returns a copy of this time with the partial set of fields replacing those
   * from this instance.
   * <p>
   ...
   * returned.
   * <p>
   * If the addition causes the maximum value of the field to be exceeded, then
   * the value will wrap. Thus 23:59 plus two minutes yields 00:01.
   * <p>
   * These lines are equivalent:
   * 
   * <pre>
   ...
   * {@link #withFieldAdded(DurationFieldType, int)} or {@link #plusHours(int)}.
   ...
   * <p>
   * LocalTime is immutable, so there are no set methods. Instead, this method
   ...
   * </pre>
   * <p>
   * Methods are also provided that allow time modification. These return new
   * instances of LocalTime - they do not modify the original. The example below
   * yields two independent immutable date objects 2 hours apart.
   * 
   * <pre>
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
    ...
    /**
     * Adds to this field in a copy of this LocalTime. If the addition exceeds
     * the maximum value (eg. 23:59) it will wrap to the minimum value (eg.
     * 00:00).
     * <p>
     * The LocalTime attached to this property is unchanged by this call.
     * @param value the value to add to the field in the copy
    ...
    /**
     * Adds to this field in a copy of this LocalTime. If the addition exceeds
     * the maximum value (eg. 23:59) then an exception will be thrown. Contrast
     * this behaviour to {@link #addCopy(int)}.
     * <p>
     * The LocalTime attached to this property is unchanged by this call.
     * @param value the value to add to the field in the copy
     * @return a copy of the LocalTime with the field value changed
    ...
    /**
     * Adds to this field, possibly wrapped, in a copy of this LocalTime. A
     * field wrapped operation only changes this field. Thus 10:59 plusWrapField
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new LocalTime with this field set to the maximum value for this
     * field.
     * <p>
     * The LocalTime attached to this property is unchanged by this call.
    ...
    /**
     * Returns a new LocalTime with this field set to the minimum value for this
     * field.
     * <p>
     * The LocalTime attached to this property is unchanged by this call.
     ...
     * LocalTime.
     * <p>
     * For example, rounding floor on the hourOfDay field of a LocalTime where
     * the time is 10:30 would result in new LocalTime with the time of 10:00.
     * @return a copy of the LocalTime with the field value changed
     */
     ...
     * <p>
     * For example, rounding floor on the hourOfDay field of a LocalTime where
     * the time is 10:30 would result in new LocalTime with the time of 11:00.
     * @return a copy of the LocalTime with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this
     * LocalTime. If halfway, the ceiling is favored over the floor only if it
     * makes this field's value even.
     * @return a copy of the LocalTime with the field value changed
     */
