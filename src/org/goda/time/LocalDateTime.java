/*
 * Copyright 2001-2007 Stephen Colebourne Licensed under the Apache License,
 ...
 * without a time zone.
 * <p>
 * LocalDateTime implements the {@link ReadablePartial} interface. To do this,
 * certain methods focus on key fields Year, MonthOfYear, DayOfYear and
 * MillisOfDay. However, <b>all</b> fields may in fact be queried.
 * <p>
 * Internally, LocalDateTime uses a single millisecond-based value to represent
 * the local datetime. This value is only used internally and is not exposed to
 * applications.
 * <p>
 * Calculations on LocalDateTime are performed using a {@link Chronology}. This
 ...
 * as well. All standard Chronology classes supplied are thread-safe and
 * immutable.
...
public final class LocalDateTime extends BaseLocal implements ReadablePartial, Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a LocalDateTime from a <code>java.util.Calendar</code> using
   ...
   * This is useful if you have been using the Calendar as a local date, ignoing
   * the zone.
   * <p>
   * This factory method ignores the type of the calendar and always creates a
   * LocalDateTime with ISO chronology. It is expected that you will only pass
   ...
   */
  /*
   * public static LocalDateTime fromCalendarFields(Calendar calendar) { if
   * (calendar == null) { throw new
   * IllegalArgumentException("The calendar must not be null"); } return new
   * LocalDateTime( calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH) +
  ...
  /**
   * Constructs a LocalDateTime from a <code>java.util.Date</code> using exactly
   * the same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Date and assigned to the LocalDateTime. This
  ...
  public static LocalDateTime fromDateFields(Date date) {
    ...
    return new LocalDateTime(date.getYear() + 1900, date.getMonth() + 1, date.getDate(), date.getHours(), date.getMinutes(),
   ...
   * <p>
   * If the chronology is null, ISO chronology in the default zone is used. Once
   * the constructor is completed, the zone is no longer used.
   * @param instant the milliseconds from 1970-01-01T00:00:00Z
   * @param chronology the chronology, null means ISOChronology in default zone
   */
   ...
   * If the object contains no time zone, the default zone is used. Once the
   * constructor is completed, the zone is no longer used.
   * <p>
   * The recognised object types are defined in
   * {@link org.joda.time.convert.ConverterManager ConverterManager} and include
   * ReadablePartial, ReadableInstant, String, Calendar and Date. The String
   * formats are described by
   * {@link ISODateTimeFormat#localDateOptionalTimeParser()}. The default String
  ...
  /**
   * Constructs an instance from an Object that represents a datetime, using the
   * specified chronology.
   * <p>
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the number of fields in this partial, which is four. The supported
  ...
  /**
   * Checks if the field type specified is supported by this local datetime and
  ...
  /**
   * Checks if the duration type specified is supported by this local datetime
   * and chronology.
   ...
   * 1970-01-01T00:00:00 (not fixed to any specific time zone).
   ...
   * order.
   * <p>
   * The fields are compared in order, from largest to smallest. The first field
   * that is non-equal is used to determine the result.
   * <p>
   * The specified object must be a partial instance whose field types match
   * those of this partial.
   * <p>
   * NOTE: This implementation violates the Comparable contract. This method
   * will accept any instance of ReadablePartial as input. However, it is
   * possible that some implementations of ReadablePartial exist that do not
   * extend AbstractPartial, and thus will throw a ClassCastException if
   * compared in the opposite direction. The cause of this problem is that
   * ReadablePartial doesn't define the compareTo() method, however we can't
   * change that until v2.0.
   * @param partial an object to check against
   * @return negative if this is less, zero if equal, positive if greater
   * @throws ClassCastException if the partial is the wrong class or if it has
  ...
  public DateTime toDateTime(DateTimeZone zone) {
    ...
    return new DateTime(getYear(), getMonthOfYear(), getDayOfMonth(), getHourOfDay(), getMinuteOfHour(), getSecondOfMinute(),
   ...
   * {@link #withFieldAdded(DurationFieldType, int)} or {@link #plusYears(int)}.
   ...
   * <p>
   * This LocalDateTime instance is immutable and unaffected by this method
   * call.
   * <p>
   ...
   * <p>
   * The weekyear is the year that matches with the weekOfWeekyear field. In the
   * standard ISO8601 week algorithm, the first week of the year is that in
   * which at least 4 days are in the year. As a result of this definition, day
   * 1 of the first week may be in the previous year. The weekyear allows you to
   * query the effective year for that day.
   * @return the weekyear
   */
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of era changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of century of era changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of year of era changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of year of century changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of day of year changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of day of week changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of hour of day changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of minute of hour changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of second of minute changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of millis of second changed.
   ...
   * <p>
   * LocalDateTime is immutable, so there are no set methods. Instead, this
   * method returns a new instance with the value of millis of day changed.
   ...
   * to get the year '1972' (as an int) and the month 'December' (as a String).
   * 
   * <pre>
   ...
   * instances of LocalDateTime - they do not modify the original. The example
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
    ...
    /**
     * Adds to this field, possibly wrapped, in a copy of this LocalDateTime. A
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new LocalDateTime with this field set to the maximum value for
     * this field.
     * <p>
     * This operation is useful for obtaining a LocalDateTime on the last day of
    ...
    /**
     * Returns a new LocalDateTime with this field set to the minimum value for
     * this field.
     * <p>
     * The LocalDateTime attached to this property is unchanged by this call.
     ...
     * where the time is 10:30 would result in new LocalDateTime with the time
     * of 10:00.
     * @return a copy of the LocalDateTime with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this
     * LocalDateTime. If halfway, the ceiling is favored over the floor only if
