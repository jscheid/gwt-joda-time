...
import org.goda.time.util.ArrayUtils;

/**
 * Partial is an immutable partial datetime supporting any set of datetime
 * fields.
 * <p>
 * A Partial instance can be used to hold any combination of fields. The
 * instance does not contain a time zone, so any datetime is local.
 * <p>
 * A Partial can be matched against an instant using
 * {@link #isMatch(ReadableInstant)}. This method compares each field on this
 * partial with those of the instant and determines if the partial matches the
 * instant. Given this definition, an empty Partial instance represents any
 * datetime and always matches.
 * <p>
 * Calculations on Partial are performed using a {@link Chronology}. This
...
public final class Partial extends AbstractPartial implements ReadablePartial, Serializable {
  ...
  /**
   * The formatter to use, [0] may miss some fields, [1] doesn't miss any
   * fields.
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a Partial with no fields or values, which can be considered to
   * represent any date.
   * <p>
   * This is most useful when constructing partials, for example:
   * 
   * <pre>
   * Partial p = new Partial().with(DateTimeFieldType.dayOfWeek(), 5).with(DateTimeFieldType.hourOfDay(), 12).with(
   *     DateTimeFieldType.minuteOfHour(), 20);
   * </pre>
   * 
   ...
   * 
   * <pre>
   * Partial p = new Partial(chrono).with(DateTimeFieldType.dayOfWeek(), 5).with(DateTimeFieldType.hourOfDay(), 12).with(
   *     DateTimeFieldType.minuteOfHour(), 20);
   * </pre>
   * 
   * Note that, although this is a clean way to write code, it is fairly
  ...
  public Partial(DateTimeFieldType type, int value, Chronology chronology) {
    ...
    chronology.valDateTime(this, iValues);
  }

  /**
   * Constructs a Partial with the specified fields and values. The fields must
   * be specified in the order largest to smallest.
   * <p>
   * The constructor uses the specified chronology.
  ...
  public Partial(DateTimeFieldType[] types, int[] values, Chronology chronology) {
    ...
    chronology.valDateTime(this, values);
    iValues = new int[values.length];
    ArrayUtils.copyArray(values, iValues);
  }

  /**
   * Constructs a Partial by copying all the fields and types from another
   * partial.
   * <p>
  ...
  /**
   * Constructs a Partial with the specified values. This constructor assigns
  ...
  /**
   * Constructs a Partial with the specified chronology, fields and values. This
   * constructor assigns and performs no validation.
  ...
  /**
   * Gets an array of the value of each of the fields that this partial
   * supports.
   * <p>
   * The fields are returned largest to smallest. Each value corresponds to the
   * same array index as <code>getFieldTypes()</code>
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new Partial instance with the specified chronology. This instance
   * is immutable and unaffected by this method call.
   * <p>
   * This method retains the values of the fields, thus the result will
   * typically refer to a different instant.
   * <p>
   * The time zone of the specified chronology is ignored, as Partial operates
   * without a time zone.
  ...
  public Partial withChronologyRetainFields(Chronology newChronology) {
    ...
    if (newChronology == getChronology()) {
      ...
      newChronology.valDateTime(newPartial, iValues);
      return newPartial;
    }
  }
  ...
  public Partial with(DateTimeFieldType fieldType, int value) {
    ...
    if (index == -1) {
      ...
      iChronology.valDateTime(newPartial, newValues);
      return newPartial;
    }
  ...
  /**
   * Gets a copy of this Partial with the value of the specified field
   * increased. If this partial does not support the field, an exception is
   * thrown.
   * <p>
   * If the addition is zero, then <code>this</code> is returned. The addition
   * will overflow into larger fields (eg. minute to hour). However, it will not
   * wrap around if the top maximum is reached.
   ...
   * <p>
   * If the addition is zero, then <code>this</code> is returned. The addition
   * will overflow into larger fields (eg. minute to hour). If the maximum is
   * reached, the addition will wra.
   * @param fieldType the field type to add to, not null
   * @param amount the amount to add
   * @return a copy of this instance with the field updated
   * @throws IllegalArgumentException if the value is null or invalid
   ...
   * <p>
   * If the addition is zero, then <code>this</code> is returned. Fields in the
   * period that aren't present in the partial are ignored.
   * <p>
   * This method is typically used to add multiple copies of complex period
   * instances. Adding one field is best achieved using the method
   ...
   * methods for getting and manipulating the partial.
   * <p>
   ...
   * <p>
   * If there is no appropriate ISO format, null is returned. This method may
   * return a formatter that does not display all the fields of the partial.
   * This might occur when you have overlapping fields, such as dayOfWeek and
   * dayOfMonth.
   * @return a formatter suitable for the fields in this partial, null if none is
   *         suitable
   */
   ...
   * <p>
   * This method will output the partial in one of two ways. If
   * {@link #getFormatter()}
   * <p>
   * If there is no appropriate ISO format a dump of the fields is output via
   * {@link #toStringList()}.
   ...
   * <p>
   * This method exists to provide a better debugging toString than the standard
   * toString. This method lists all the fields and their values in a style
   * similar to the collections framework.
  ...
  /**
   * Output the date using the specified format pattern. Unsupported fields will
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
     ...
     * added solely to this field then it will affect larger fields. Smaller
     * fields are unaffected.
     * <p>
     * If the result would be too large, beyond the maximum year, then an
     * IllegalArgumentException is thrown.
     * <p>
     * The Partial attached to this property is unchanged by this call. Instead,
    ...
    /**
     * Adds to the value of this field in a copy of this Partial wrapping within
     * this field if the maximum value is reached.
     * <p>
     * The value will be added to this field. If the value is too large to be
     * added solely to this field then it wraps within this field. Other fields
     * are unaffected.
     * <p>
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new Partial with this field set to the maximum value for this
     * field.
     * <p>
    ...
    /**
     * Returns a new Partial with this field set to the minimum value for this
     * field.
     * <p>
     * The Partial attached to this property is unchanged by this call.
