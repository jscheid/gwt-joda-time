...
public abstract class DurationField extends Field implements Comparable {
   ...
   * <p>
   * For imprecise fields, the unit size is variable, and so this method returns
   * a suitable average value.
  ...
  //------------------------------------------------------------------------
  /**
   * Get the value of this field from the milliseconds, which is approximate if
   * this field is imprecise.
   ...
   * instant. For precise fields this method produces the same result as for the
   * single argument getMillis method.
   * <p>
  ...
  /**
   * Compares this duration field with another duration field for ascending unit
   * millisecond order. This ordering is inconsistent with equals, as it ignores
   * name and precision.
   ...
   * @param locale the locale to use for selecting a unit name, null for default
