...
/**
 * Divides a DateTimeField such that the retrieved values are reduced by a fixed
 * divisor. The field's unit duration is scaled accordingly, but the range
...
public class DividedDateTimeField extends DecoratedDateTimeField {
  ...
  /**
   * Add the specified amount of scaled units to the specified time instant. The
  ...
  /**
   * Add to the scaled component of the specified time instant, wrapping around
