 ...
 * <p>
 * This is most useful for years where you want to skip zero, so the sequence
 * runs ...,2,1,-1,-2,...
 * <p>
...
public final class SkipDateTimeField extends DelegatedDateTimeField {
  ...
  public long set(long millis, int value) {
    ...
    if (value <= iSkip) {
      if (value == iSkip) {
        throw new IllegalFieldValueException(DateTimeFieldType.year(), new Integer(value), null, null);
      }
      value++;
    }
