...
/**
 * Converts a strict DateTimeField into a lenient one. By being lenient, the set
 * method accepts out of bounds values, performing an addition instead.
 * <p>
...
public class LenientDateTimeField extends DelegatedDateTimeField {
  ...
  /**
   * Set values which may be out of bounds by adding the difference between the
