 ...
 * imprecise durations. If both duration fields are precise, then a
 * {@link PreciseDateTimeField} should be used instead.
 * <p>
 * When defining imprecise DateTimeFields where a matching DurationField is
 * already available, just extend BaseDateTimeField directly so as not to create
 * redundant DurationField instances.
 * <p>
...
public abstract class ImpreciseDateTimeField extends BaseDateTimeField {
   ...
   * <p>
   * The default implementation call getDifferenceAsLong and converts the return
   * value to an int.
