 ...
 * <p>
 * This DateTimeField is useful for defining DateTimeFields that are composed of
 * precise durations, like time of day fields. If either duration field is
...
public class PreciseDateTimeField extends PreciseDurationDateTimeField {
   ...
   * @throws IllegalArgumentException if unit milliseconds is less than one or
   *           effective value range is less than two.
   */
  ...
  /**
   * Add to the component of the specified time instant, wrapping around within
   ...
   * <p>
   * For example, 60 for seconds per minute. The field is allowed values from 0
   * to range - 1.
   * @return unit range
   */
  public int getRange() {
