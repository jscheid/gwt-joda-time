...
public abstract class BaseDateTimeField extends DateTimeField {
   ...
   * <p>
   * The default implementation internally calls set. Subclasses are encouraged
   ...
   * @param minuendInstant the milliseconds from 1970-01-01T00:00:00Z to subtract
   *          from
   ...
   * <p>
   * The value of this field will be set. If the value is invalid, an exception
   * if thrown.
   * <p>
   ...
   * <p>
   * The value of this field (specified by the index) will be set. If the value
   * is invalid, an exception if thrown.
   * <p>
   * If setting this field would make other fields invalid, then those fields
   * may be changed. For example if the current date is the 31st January, and
   * the month is set to February, the day would be invalid. Instead, the day
   ...
   * this field and all fields of a higher magnitude are retained. The
   ...
   * all fields of a higher magnitude may be incremented in order to achieve
   * this result. The fractional millis that cannot be expressed in whole
   * increments of this field are set to minimum.
   * <p>
   ...
   * as a result, adds one field unit. Subclasses are encouraged to provide a
  ...
  /**
   * Round to the nearest whole unit of this field. If the given millisecond
   * value is closer to the floor, this function behaves like roundFloor. If the
