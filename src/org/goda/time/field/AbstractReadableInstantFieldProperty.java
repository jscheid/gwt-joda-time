 ...
 * <p>
 * It allows the date and time manipulation code to be field based yet still
 * easy to use.
 * <p>
 * AbstractReadableInstantFieldProperty itself is thread-safe and immutable, but
 * the ReadableInstant being operated on may be mutable and not thread-safe.
...
public abstract class AbstractReadableInstantFieldProperty implements Serializable {
   ...
   * <p>
   * This method returns the value converted to a <code>String</code> using
   * <code>Integer.toString</code>. This method does NOT return textual
   * descriptions such as 'Monday' or 'January'. See {@link #getAsText()} and
   * {@link #getAsShortText()} for those.
   * @return the current value
   * @see DateTimeField#get
   * @since 1.1
   */
  ...
  /**
   * Gets the textual value of this property from the instant as a string in the
   * default locale.
   * <p>
   * This method returns the value converted to a <code>String</code> returning
   * the appropriate textual description wherever possible. Thus, a day of week
   * of 1 would return 'Monday' in English.
  ...
  /**
   * Gets the short textual value of this property from the instant as a string
   * in the default locale.
   * <p>
   * This method returns the value converted to a <code>String</code> returning
   * the appropriate textual description wherever possible. Thus, a day of week
   * of 1 would return 'Mon' in English.
   * @return the current text value
   ...
   * passed in, in the units of this field. The sign of the difference matches
   * that of compareTo. In other words, this field property's instant is the
   * minuend.
  ...
  /**
   * Returns the interval that represents the range of the minimum and maximum
   * values of this field.
   * <p>
   * For example, <code>datetime.monthOfYear().toInterval()</code> will return
   * an interval over the whole month.
   ...
   * hourOfDay field, then the hourOfDay field of the other instant will be
   * queried whether in the same chronology or not.
   ...
   * The comparison is based on the value of the same field type, irrespective
   * of any difference in chronology. Thus, if this property represents the
   * hourOfDay field, then the hourOfDay field of the other partial will be
   * queried whether in the same chronology or not.
