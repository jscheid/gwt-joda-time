...
/**
 * ReadablePartialConverter extracts partial fields and chronology from a
 * ReadablePartial.
...
class ReadablePartialConverter extends AbstractConverter implements PartialConverter {
   ...
   * <p>
   * If the passed in chronology is non-null, it is used. Otherwise the
   * chronology from the instant is used.
   * @param object the ReadablePartial to convert, must not be null
  ...
  public int[] getPartialValues(ReadablePartial fieldSource, Object object, Chronology chrono) {
    ...
    chrono.valDateTime(fieldSource, values);
    return values;
  }
