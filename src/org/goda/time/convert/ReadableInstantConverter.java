...
/**
 * ReadableInstantConverter extracts milliseconds and chronology from a
 * ReadableInstant.
...
class ReadableInstantConverter extends AbstractConverter implements InstantConverter, PartialConverter {
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the chronology, which is taken from the ReadableInstant. If the
   * chronology on the instant is null, the ISOChronology in the specified time
   * zone is used. If the chronology on the instant is not in the specified
   * zone, it is adapted.
