...
public abstract class AbstractConverter implements Converter {
  ...
  //-----------------------------------------------------------------------
  /**
   * Extracts the chronology from an object of this convertor's type where the
  ...
  /**
   * Extracts the chronology from an object of this convertor's type where the
   * chronology is specified.
   * <p>
   * This implementation returns the chronology specified, or the ISO chronology
   * in the default zone if null passed in.
   * @param object the object to convert
   ...
   * {@link #getPartialValues(ReadablePartial, Object, Chronology)}.
   * @param fieldSource a partial that provides access to the fields. This
   *          partial may be incomplete and only getFieldType(int) should be
   *          used
   * @param object the object to convert
