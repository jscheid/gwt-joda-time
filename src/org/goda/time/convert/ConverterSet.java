...
class ConverterSet {
  ...
  /**
   * Returns the closest matching converter for the given type, or null if none
   * found.
   ...
   * converter is already in the set, the given converter replaces it. If the
   * converter is exactly the same as one already in the set, the original set
   * is returned.
