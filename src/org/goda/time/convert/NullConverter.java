...
/**
 * NullConverter converts null to an instant, partial, duration, period or
 * interval. Null means now for instant/partial, zero for duration/period and
 * from now to now for interval.
 * @author Stephen Colebourne
 * @author Brian S O'Neill
 * @since 1.0
 */
class NullConverter extends AbstractConverter implements InstantConverter, PartialConverter, DurationConverter, PeriodConverter,
    IntervalConverter {
  ...
  //-----------------------------------------------------------------------
  /**
   * Extracts interval endpoint values from an object of this converter's type,
   * and sets them into the given ReadWritableInterval.
