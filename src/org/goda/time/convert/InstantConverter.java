...
/**
 * InstantConverter defines how an object is converted to
 * milliseconds/chronology.
 * <p>
...
public interface InstantConverter extends Converter {
  ...
  /**
   * Extracts the chronology from an object of this converter's type where the
   * chronology may be specified.
   * <p>
   * If the chronology is non-null it should be used. If it is null, then the
   * object should be queried, and if it has no chronology then ISO default is
   * used.
   * @param object the object to convert
   ...
   * <p>
   * The chronology passed in is the result of the call to
   * <code>getChronology</code>.
   * @param object the object to convert
