...
/**
 * Defines an instant in the datetime continuum. This interface expresses the
 * datetime as milliseconds from 1970-01-01T00:00:00Z.
 * <p>
 ...
 * <code>ReadableInstant</code> as a parameter if the method only wants to read
 * the instant without needing to know the specific datetime fields.
...
public interface ReadableInstant extends Comparable {
   ...
   * <p>
   * The {@link Chronology} provides conversion from the millisecond value to
   * meaningful fields in a particular calendar system.
  ...
  /**
   * Checks whether the field type specified is supported by this
   * implementation.
   ...
   * millisecond instant and the Chronology. All ReadableInstant instances are
   * accepted.
   * <p>
   ...
   * 
   * <pre>
   * ((int) (getMillis() &circ; (getMillis() &gt;&gt;&gt; 32))) + (getChronology().hashCode())
   * </pre>
   ...
   * <p>
   * The string output is in ISO8601 format to enable the String constructor to
   * correctly parse it.
