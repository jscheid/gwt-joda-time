...
import org.goda.time.convert.InstantConverter;

/**
 * Instant is the standard implementation of a fully immutable instant in time.
 * <p>
 * <code>Instant</code> is an implementation of {@link ReadableInstant}. As with
 * all instants, it represents an exact point on the time-line, but limited to
 * the precision of milliseconds. An <code>Instant</code> should be used to
 * represent a point in time irrespective of any other factor, such as
...
public final class Instant extends AbstractInstant implements ReadableInstant, Serializable {
   ...
   * @throws ArithmeticException if the new instant exceeds the capacity of a
   *           long
   */
   ...
   * <p>
   * This method returns a DateTime object in the default zone. This differs
   * from the similarly named method on DateTime, DateMidnight or
   * MutableDateTime which retains the time zone. The difference is because
   * Instant really represents a time <i>without</i> a zone, thus calling this
   * method we really have no zone to 'retain' and hence expect to switch to the
   * default zone.
   * <p>
   * This method definition preserves compatability with earlier versions of
   * Joda-Time.
  ...
  /**
   * Get this object as a DateTime using ISOChronology in the default zone. This
   * method is identical to <code>toDateTime()</code>.
   * <p>
   * This method returns a DateTime object in the default zone. This differs
   * from the similarly named method on DateTime, DateMidnight or
   * MutableDateTime which retains the time zone. The difference is because
  ...
  /**
   * Get this object as a MutableDateTime using ISOChronology in the default
   * zone.
   * <p>
   * This method returns a MutableDateTime object in the default zone. This
   * differs from the similarly named method on DateTime, DateMidnight or
   * MutableDateTime which retains the time zone. The difference is because
   * Instant really represents a time <i>without</i> a zone, thus calling this
   * method we really have no zone to 'retain' and hence expect to switch to the
   * default zone.
  ...
  /**
   * Get this object as a MutableDateTime using ISOChronology in the default
   * zone. This method is identical to <code>toMutableDateTime()</code>.
   * <p>
   * This method returns a MutableDateTime object in the default zone. This
   * differs from the similarly named method on DateTime, DateMidnight or
   * MutableDateTime which retains the time zone. The difference is because
