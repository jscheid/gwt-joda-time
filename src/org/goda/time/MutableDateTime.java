 ...
 * class. It holds the datetime as milliseconds from the Java epoch of
 ...
 * </ul>
 * <p>
 * MutableDateTime is mutable and not thread-safe, unless concurrent threads are
...
public class MutableDateTime extends BaseDateTime implements ReadWritableDateTime, Cloneable, Serializable {
   ...
   * @param zone the time zone, null means default time zone
   */
  public MutableDateTime(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute,
  ...
  /**
   * Sets the status of rounding to use the specified field and ROUND_FLOOR
   * mode. A null field will disable rounding. Once set, the instant is then
   * rounded using the new field and mode.
   * <p>
   * Enabling rounding will cause all subsequent calls to
   * {@link #setMillis(long)} to be rounded. This can be used to control the
   * precision of the instant, for example by setting a rounding field of
   * minuteOfDay, the seconds and milliseconds will always be zero.
  ...
  /**
   * Sets the status of rounding to use the specified field and mode. A null
   * field or mode of ROUND_NONE will disable rounding. Once set, the instant is
   * then rounded using the new field and mode.
   * <p>
   * Enabling rounding will cause all subsequent calls to
   * {@link #setMillis(long)} to be rounded. This can be used to control the
   * precision of the instant, for example by setting a rounding field of
   ...
   * @throws IllegalArgumentException if mode is unknown, no exception if field
   *           is null
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Sets the time zone of the datetime, changing the chronology and field
   * values.
   * <p>
   * Changing the zone using this method retains the millisecond instant. The
   * millisecond instant is adjusted in the new zone to compensate. chronology.
   * Setting the time zone does not affect the millisecond value of this
   * instant.
   * <p>
  ...
  /**
   * Sets the time zone of the datetime, changing the chronology and
   * millisecond.
   * <p>
   * Changing the zone using this method retains the field values. The
   * millisecond instant is adjusted in the new zone to compensate.
   * <p>
   * If the chronology already has this time zone, no change occurs.
   * @param newZone the time zone to use, null means default zone
   * @see #setZone
  ...
  /**
   * Add a number of milliseconds to the date. The implementation of this method
   * differs from the {@link #add(long)} method in that a DateTimeField performs
   * the addition.
  ...
  //-----------------------------------------------------------------------
  /**
   * Set the date from milliseconds. The time part of this object will be
   * unaffected.
  ...
  /**
   * Set the date from another instant. The time part of this object will be
   * unaffected.
   * @param instant an instant to copy the date from, time part ignored
  ...
  //-----------------------------------------------------------------------
  /**
   * Set the time from milliseconds. The date part of this object will be
   * unaffected.
  ...
  /**
   * Set the time from another instant. The date part of this object will be
   * unaffected.
   ...
   * @throws IllegalArgumentException if the value is invalid
   */
  public void setDateTime(final int year, final int monthOfYear, final int dayOfMonth, final int hourOfDay, final int minuteOfHour,
  ...
  /**
   * MutableDateTime.Property binds a MutableDateTime to a DateTimeField
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
    ...
    /**
     * Round to the nearest whole unit of this field. If halfway, the ceiling is
     * favored over the floor only if it makes this field's value even.
     * @return the mutable datetime being used, so calls can be chained
