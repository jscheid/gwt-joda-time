 ...
 * {@link ReadableInstant} interface should be used when different kinds of
 * date/time objects are to be referenced.
 * <p>
 * Whenever you want to implement <code>ReadableInstant</code> you should extend
 * this class.
 * <p>
...
public abstract class AbstractInstant implements ReadableInstant {
  ...
  /**
   * Get the value of one of the fields of a datetime using the chronology of
   * the instant.
   * <p>
   * This method uses the chronology of the instant to obtain the value. For
   * example:
   * 
   * <pre>
  ...
  /**
   * Checks if the field type specified is supported by this instant and
   ...
   * <p>
   * This could be used to get a field using a different Chronology. For
   * example:
   * 
   * <pre>
  ...
  /**
   * Get this object as a DateTime using the same chronology but a different
   * zone.
  ...
  /**
   * Get this object as a MutableDateTime using the same chronology but a
   * different zone.
   * @param zone time zone to apply, or default if null
   * @return a MutableDateTime using the same millis
   */
  ...
  /**
   * Get this object as a MutableDateTime using the given chronology and its
   * zone.
   * @param chronology chronology to apply, or ISOChronology if null
   * @return a MutableDateTime using the same millis
   */
   ...
   * <p>
   * Two objects which represent the same instant in time, but are in different
   * time zones (based on time zone id), will be considered to be different.
   * Only two objects with the same {@link DateTimeZone}, {@link Chronology} and
   * instant are equal.
   * <p>
   * See {@link #isEqual(ReadableInstant)} for an equals method that ignores the
  ...
  /**
   * Compares this object with the specified object for ascending millisecond
   * instant order. This ordering is inconsistent with equals, as it ignores the
   * Chronology.
   * <p>
   * All ReadableInstant instances are accepted.
  ...
  //-----------------------------------------------------------------------
  /**
   * Is this instant after the millisecond instant passed in comparing solely by
   * millisecond.
  ...
  /**
   * Is this instant after the instant passed in comparing solely by
   * millisecond.
  ...
  //-----------------------------------------------------------------------
  /**
   * Is this instant before the millisecond instant passed in comparing solely
   * by millisecond.
   * @param instant a millisecond instant to check against
  ...
  /**
   * Is this instant before the instant passed in comparing solely by
   * millisecond.
   * @param instant an instant to check against, null means now
  ...
  //-----------------------------------------------------------------------
  /**
   * Is this instant equal to the millisecond instant passed in comparing solely
   * by millisecond.
   * @param instant a millisecond instant to check against
   * @return true if this instant is before the instant passed in
   */
  ...
  /**
   * Is this instant equal to the current instant comparing solely by
   * millisecond.
   * @return true if this instant is before the current instant
   */
  ...
  /**
   * Is this instant equal to the instant passed in comparing solely by
   * millisecond.
   * @param instant an instant to check against, null means now
