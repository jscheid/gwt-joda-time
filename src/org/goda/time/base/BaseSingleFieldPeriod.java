...
public abstract class BaseSingleFieldPeriod implements ReadablePeriod, Comparable, Serializable {
   ...
   * @param start the start instant, valDateTimed to not be null
   * @param end the end instant, valDateTimed to not be null
  ...
  //-----------------------------------------------------------------------
  /**
   * Calculates the number of whole units between the two specified partial
   * datetimes.
   * <p>
   * The two partials must contain the same fields, for example you can specify
   * two <code>LocalDate</code> objects.
   * @param start the start partial date, valDateTimed to not be null
   * @param end the end partial date, valDateTimed to not be null
  ...
  /**
   * Creates a new instance representing the number of complete standard length
   * units in the specified period.
   * <p>
   ...
   * @param millisPerUnit the number of milliseconds in one standard unit of
   *          this period
    ...
    for (int i = 0; i < period.size(); i++) {
      ...
      if (value != 0) {
        ...
        if (field.isPrecise() == false) {
          throw new IllegalArgumentException("Cannot convert period to duration as " + field.getName() + " is not precise in the period "
              + period);
        }
  ...
  /**
   * Sets the amount of this period. To make a subclass immutable you must
   * declare it final, or block this method.
   ...
   * <p>
   * The only index supported by this period is zero which returns the field
   * type of this class.
   ...
   * <p>
   * If the field type specified does not match the type used by this class then
   * zero is returned.
  ...
  //-----------------------------------------------------------------------
  /**
   * Get this period as an immutable <code>Period</code> object. The period will
   * use <code>PeriodType.standard()</code>.
   ...
   * fields. The period will use <code>PeriodType.standard()</code>.
   ...
   * @return true if all the field values are equal, false if not or the period
   *         is null or of an incorrect type
   */
