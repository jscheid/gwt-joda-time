...
/**
 * BasePartial is an abstract implementation of ReadablePartial that stores data
 * in array and <code>Chronology</code> fields.
 * <p>
 * This class should generally not be used directly by API users. The
 * {@link org.joda.time.ReadablePartial} interface should be used when different
...
public abstract class BasePartial extends AbstractPartial implements ReadablePartial, Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a partial with the current time, using ISOChronology in the
  ...
  /**
   * Private constructor to be used by subclasses only which performs no
   * validation.
   * <p>
   ...
   * validation.
   * <p>
   * Data is assigned (not cloned) to the new instance. This should not be used
   * by mutable subclasses.
   * @param base the base partial
  ...
  protected void setValues(int[] values) {
    getChronology().valDateTime(this, values);
    iValues = values;
  }
