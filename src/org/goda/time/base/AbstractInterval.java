...
public abstract class AbstractInterval implements ReadableInterval {
   ...
   * @param millisInstant the instant to compare to, millisecond instant from
   ...
   * <p>
   * Intervals are inclusive of the start instant and exclusive of the end. Only
   * the end time of the specified interval is used in the comparison.
   * @param interval the interval to compare to, null means now
