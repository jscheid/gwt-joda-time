...
/**
 * AbstractPartial provides a standard base implementation of most methods in
 * the ReadablePartial interface.
 * <p>
 * Calculations on are performed using a {@link Chronology}. This chronology is
 * set to be in the UTC time zone for all calculations.
 * <p>
 * The methods on this class use {@link ReadablePartial#size()},
 * {@link AbstractPartial#getField(int, Chronology)} and
 * {@link ReadablePartial#getValue(int)} to calculate their results. Subclasses
 * may have a better implementation.
 * <p>
...
public abstract class AbstractPartial implements ReadablePartial, Comparable {
   ...
   * <p>
   * The fields are returned largest to smallest, for example Hour, Minute,
   * Second.
   * @return the fields supported in an array that may be altered, largest to
   *         smallest
   */
   ...
   * <p>
   * The fields are returned largest to smallest, for example Hour, Minute,
   * Second. Each value corresponds to the same array index as
   * <code>getFields()</code>
   * @return the current values of each field in an array that may be altered,
   *         largest to smallest
   */
  ...
  /**
   * Gets the index of the specified field, throwing an exception if the field
   * is unsupported.
  ...
  /**
   * Gets the index of the first fields to have the specified duration, or -1 if
  ...
  /**
   * Gets the index of the first fields to have the specified duration, throwing
   * an exception if the field is unsupported.
   * @param type the type to check, not null
   * @return the index of the field
   * @throws IllegalArgumentException if the field is null or not supported
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Resolves this partial against another complete instant to create a new full
   * instant. The combination is performed using the chronology of the specified
   * instant.
   * <p>
   * For example, if this partial represents a time, then the result of this
   * method will be the datetime from the specified base instant plus the time
   * from this partial.
  ...
  /**
   * Gets a hash code for the ReadablePartial that is compatible with the equals
   * method.
   ...
   * that is non-equal is used to determine the result.
   * <p>
   * You may not pass null into this method. This is because you need a time
   * zone to accurately determine the current date.
   ...
   * <p>
   * The fields are compared in order, from largest to smallest. If all fields
   ...
   * @param formatter the formatter to use, null means use
   *          <code>toString()</code>.
