...
/**
 * BasePeriod is an abstract implementation of ReadablePeriod that stores data
 * in a <code>PeriodType</code> and an <code>int[]</code>.
 * <p>
 * This class should generally not be used directly by API users. The
 * {@link ReadablePeriod} interface should be used when different kinds of
 * period objects are to be referenced.
 * <p>
...
public abstract class BasePeriod extends AbstractPeriod implements ReadablePeriod, Serializable {
   ...
   * <p>
   * Only fields that are precise will be used. Thus the largest precise field
   ...
   * @param type which set of fields this period supports, null means use type
   *          from object
   * @param chrono the chronology to use, null means ISO default
  ...
  //-----------------------------------------------------------------------
  /**
   * ValDateTimes a period type, converting nulls to a default value and
   * checking the type is suitable for this instance.
   * @param type the type to check, may be null
   * @return the valDateTimed type to use, not null
   ...
   * instant.
   * <p>
   * This method adds the period to the specified instant in order to calculate
   * the duration.
   * <p>
   * An instant must be supplied as the duration of a period varies. For
   * example, a period of 1 month could vary between the equivalent of 28 and 31
   * days in milliseconds due to different length months. Similarly, a day can
   * vary at Daylight Savings cutover, typically between 23 and 25 hours.
   * @param startInstant the instant to add the period to, thus obtaining the
   *          duration
   * @return the total length of the period as a duration relative to the start
   *         instant
   * @throws ArithmeticException if the millis exceeds the capacity of the
   *           duration
   */
  ...
  /**
   * Gets the total millisecond duration of this period relative to an end
   * instant.
   * <p>
   * This method subtracts the period from the specified instant in order to
   ...
   * days in milliseconds due to different length months. Similarly, a day can
   * vary at Daylight Savings cutover, typically between 23 and 25 hours.
   * @param endInstant the instant to subtract the period from, thus obtaining
   *          the duration
   * @return the total length of the period as a duration relative to the end
   *         instant
   * @throws ArithmeticException if the millis exceeds the capacity of the
   *           duration
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Checks whether a field type is supported, and if so adds the new value to
   * the relevent index in the specified array.
