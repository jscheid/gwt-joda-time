 ...
 * durations are to be referenced.
 * <p>
...
public abstract class AbstractDuration implements ReadableDuration {
   ...
   * minute, second and millisecond fields on the period will be used. The year,
   * month, week and day fields will not be populated.
   * <p>
   * If the duration is small, less than one day, then this method will perform
   * as you might expect and split the fields evenly. If the duration is larger
   * than one day then all the remaining duration will be stored in the largest
   * available field, hours in this case.
   * <p>
   ...
   * with an instant, see
   * {@link Period#Period(ReadableInstant,ReadableDuration)}.
   ...
   * millisecond length. All ReadableDuration instances are accepted.
  ...
  /**
   * Gets a hash code for the duration that is compatible with the equals
   * method.
   * @return a hash code
   */
  public int hashCode() {
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the value as a String in the ISO8601 duration format including only
