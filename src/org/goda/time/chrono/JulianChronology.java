 ...
 * fourth year as leap. This implementation follows the leap year rule strictly,
 * even for dates before 8 CE, where leap years were actually irregular. In the
 * Julian calendar, year zero does not exist: 1 BCE is followed by 1 CE.
 * <p>
...
public final class JulianChronology extends BasicGJChronology {
  ...
  static int adjustYearForSet(int year) {
    if (year <= 0) {
      if (year == 0) {
        throw new IllegalFieldValueException(DateTimeFieldType.year(), new Integer(year), null, null);
      }
      year++;
    }
    return year;
  ...
  /**
   * Gets an instance of the JulianChronology. The time zone of the returned
   * instance is UTC.
