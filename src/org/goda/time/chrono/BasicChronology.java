 ...
 * day/month/year/leapYear model. Most of the utility methods required by
 * subclasses are package-private, reflecting the intention that they be defined
 * in the same package.
 * <p>
 * BasicChronology is thread-safe and immutable, and all subclasses must be as
 * well.
...
abstract class BasicChronology extends AssembledChronology {
  ...
  public long getDateTimeMillis(int year, int monthOfYear, int dayOfMonth, int hourOfDay, int minuteOfHour, int secondOfMinute,
    ...
    return getDateMidnightMillis(year, monthOfYear, dayOfMonth) + hourOfDay * DateTimeConstants.MILLIS_PER_HOUR + minuteOfHour
        * DateTimeConstants.MILLIS_PER_MINUTE + secondOfMinute * DateTimeConstants.MILLIS_PER_SECOND + millisOfSecond;
  }
  ...
  /**
   * Gets the maximum number of days in the month specified by the instant. The
   * value represents what the user is trying to set, and can be used to
  ...
  /**
   * Gets the total number of millis elapsed in this year at the start of the
   * specified month, such as zero for month 1.
   * @param year the year
   * @param month the month
  ...
  /**
   * Gets the maximum month for the specified year. This implementation calls
   * getMaxMonth().
   * @param year the year
