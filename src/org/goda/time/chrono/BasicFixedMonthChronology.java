...
/**
 * Abstract implementation of a calendar system based around fixed length
 * months.
 * <p>
 * As the month length is fixed various calculations can be optimised. This
 * implementation assumes any additional days after twelve months fall into a
 * thirteenth month.
 * <p>
 * BasicFixedMonthChronology is thread-safe and immutable, and all subclasses
 * must be as well.
