...
/**
 * Abstract Chronology for implementing chronologies based on Gregorian/Julian
 * formulae. Most of the utility methods required by subclasses are
 * package-private, reflecting the intention that they be defined in the same
 * package.
 * <p>
 * BasicGJChronology is thread-safe and immutable, and all subclasses must be as
 * well.
...
abstract class BasicGJChronology extends BasicChronology {
  ...
  int getMonthOfYear(long millis, int year) {
    ...
    return (isLeapYear(year)) ? ((i < 182 * 84375) ? ((i < 91 * 84375) ? ((i < 31 * 84375) ? 1 : (i < 60 * 84375) ? 2 : 3)
        : ((i < 121 * 84375) ? 4 : (i < 152 * 84375) ? 5 : 6)) : ((i < 274 * 84375) ? ((i < 213 * 84375) ? 7 : (i < 244 * 84375) ? 8 : 9)
        : ((i < 305 * 84375) ? 10 : (i < 335 * 84375) ? 11 : 12))) : ((i < 181 * 84375) ? ((i < 90 * 84375) ? ((i < 31 * 84375) ? 1
        : (i < 59 * 84375) ? 2 : 3) : ((i < 120 * 84375) ? 4 : (i < 151 * 84375) ? 5 : 6)) : ((i < 273 * 84375) ? ((i < 212 * 84375) ? 7
        : (i < 243 * 84375) ? 8 : 9) : ((i < 304 * 84375) ? 10 : (i < 334 * 84375) ? 11 : 12)));
  }
