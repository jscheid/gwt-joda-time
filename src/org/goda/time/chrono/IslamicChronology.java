 ...
 * <p>
 * This calendar is a lunar calendar with a shorter year than ISO. Year 1 in the
 * Islamic calendar began on July 16, 622 CE (Julian), thus Islamic years do not
 * begin at the same time as Julian years. This chronology is not proleptic, as
 * it does not allow dates before the first Islamic year.
 * <p>
 * There are two basic forms of the Islamic calendar, the tabular and the
 * observed. The observed form cannot easily be used by computers as it relies
 * on human observation of the new moon. The tabular calendar, implemented here,
 * is an arithmetical approximation of the observed form that follows relatively
 * simple rules.
 * <p>
 * The tabular form of the calendar defines 12 months of alternately 30 and 29
 * days. The last month is extended to 30 days in a leap year. Leap years occur
 * according to a 30 year cycle. There are four recognised patterns of leap
 * years in the 30 year cycle:
 * 
 * <pre>
 ...
 * default (16-based).
 * <p>
 * This implementation defines a day as midnight to midnight exactly as per the
 * ISO chronology. This correct start of day is at sunset on the previous day,
 * however this cannot readily be modelled and has been ignored.
 * <p>
...
public final class IslamicChronology extends BasicChronology {
  ...
  /**
   * Constant value for 'Anno Hegirae', equivalent to the value returned for
   * AD/CE.
   */
   ...
   * getYear method overflows when it adds the approximate millis at the epoch.
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets an instance of the IslamicChronology. The time zone of the returned
   * instance is UTC.
  ...
  public static class LeapYearPatternType implements Serializable {
    ...
    /**
     * Constructor. This constructor takes a bit pattern where bits 0-29
     * correspond to years 0-29 in the 30 year Islamic cycle of years. This
     * allows a highly efficient lookup by bit-matching.
