 ...
 * <p>
 * BaseChronology is thread-safe and immutable, and all subclasses must be as
 * well.
...
public abstract class BaseChronology extends Chronology implements Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * ValDateTimes whether the fields stored in a partial instant are valid.
   * <p>
   * This implementation uses
   * {@link DateTimeField#getMinimumValue(ReadablePartial, int[])} and
   * {@link DateTimeField#getMaximumValue(ReadablePartial, int[])}.
   * @param partial the partial instant to valDateTime
   * @param values the values to valDateTime, not null
   * @throws IllegalArgumentException if the instant is invalid
   */
  public void valDateTime(ReadablePartial partial, int[] values) {
   ...
   * <p>
   * DayOfWeek values are defined in {@link org.joda.time.DateTimeConstants
   * DateTimeConstants}. They use the ISO definitions, where 1 is Monday and 7
   * is Sunday.
   * @return DateTimeField or UnsupportedDateTimeField if unsupported
   */
