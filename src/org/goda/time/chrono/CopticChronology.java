...
public final class CopticChronology extends BasicFixedMonthChronology {
  ...
  /**
   * Constant value for 'Anno Martyrum' or 'Era of the Martyrs', equivalent to
   * the value returned for AD/CE.
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets an instance of the CopticChronology. The time zone of the returned
   * instance is UTC.
