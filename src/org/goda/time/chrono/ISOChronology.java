...
/**
 * Implements a chronology that follows the rules of the ISO8601 standard, which
 * is compatible with Gregorian for all modern dates. When ISO does not define a
 * field, but it can be determined (such as AM/PM) it is included.
 * <p>
...
public final class ISOChronology extends AssembledChronology {
  ...
  /**
   * Gets an instance of the ISOChronology. The time zone of the returned
   * instance is UTC.
  ...
  protected void assemble(Fields fields) {
    if (getBase().getZone() == DateTimeZone.UTC) {
      ...
      fields.weekyearOfCentury = new RemainderDateTimeField((DividedDateTimeField) fields.centuryOfEra,
