 ...
 * each 30 days in length. An extra period at the end of the year is either 5 or
 * 6 days in length. In this implementation, it is considered a 13th month.
 * <p>
 ...
 * ISO chronology. Some references indicate that a coptic day starts at sunset
 * on the previous ISO day, but this has not been confirmed and is not
 * implemented.
 * <p>
...
public final class EthiopicChronology extends BasicFixedMonthChronology {
  ...
  /**
   * Constant value for 'Ethiopean Era', equivalent to the value returned for
   * AD/CE.
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets an instance of the EthiopicChronology. The time zone of the returned
   * instance is UTC.
  ...
  private Object readResolve() {
    ...
    return base == null ? getInstance(DateTimeZone.UTC, getMinimumDaysInFirstWeek()) : getInstance(base.getZone(),
