 ...
 * <p>
 * <code>Days</code> is an immutable period that can only store days. It does
 * not store years, months or hours for example. As such it is a type-safe way
 * of representing a number of days in an application.
 * <p>
...
public final class Days extends BaseSingleFieldPeriod {
   ...
   * <code>Days</code> is immutable, so instances can be cached and shared. This
   * factory method provides access to shared instances.
   ...
   * the two specified datetimes. This method corectly handles any daylight
   ...
   * specified interval. This method corectly handles any daylight savings time
   * changes that may occur during the interval.
   ...
   * the days component may be non-zero. If any other component is non-zero, an
   ...
   * long. This is not true when daylight savings is considered and may also not
   * be true for some unusual chronologies. However, it is included as it is a
  ...
  /**
   * Converts this period in days to a period in minutes assuming a 24 hour day
   * and 60 minute hour.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all days are 24 hours
  ...
  /**
   * Converts this period in days to a period in seconds assuming a 24 hour day,
   ...
   * hours are 60 minutes and all minutes are 60 seconds. This is not true when
   * daylight savings time is considered, and may also not be true for some
   ...
   * <p>
   * This instance is immutable and unaffected by this method call.
   * @param days the amount of days to take away, may be negative, null means
   *          zero
   * @return the new period minus the specified number of days
   * @throws ArithmeticException if the result overflows an int
   */
  ...
  /**
   * Returns a new instance with the days divided by the specified divisor. The
