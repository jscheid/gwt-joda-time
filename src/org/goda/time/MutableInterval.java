 ...
 * <p>
 * MutableInterval is mutable and not thread-safe, unless concurrent threads are
...
public class MutableInterval extends BaseInterval implements ReadWritableInterval, Cloneable, Serializable {
  ...
  /**
   * Sets this interval from two instants, replacing the chronology with that
   * from the start instant.
   ...
   * @param endInstant the end of the time interval, millisecond instant from
   *          1970-01-01T00:00:00Z
   * @throws IllegalArgumentException if the end is before the start
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Sets the period of this time interval, preserving the start instant and
   * using the ISOChronology in the default zone for calculations.
  ...
  /**
   * Sets the period of this time interval, preserving the end instant and using
   * the ISOChronology in the default zone for calculations.
   * @param period new period for interval, null means zero length
   * @throws IllegalArgumentException if the end is before the start
   * @throws ArithmeticException if the start instant exceeds the capacity of a
   *           long
