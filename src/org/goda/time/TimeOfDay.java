...
public final class TimeOfDay extends BasePartial implements ReadablePartial, Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * Constructs a TimeOfDay from a <code>java.util.Calendar</code> using exactly
   * the same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Calendar and assigned to the TimeOfDay. This
   ...
   * states that the time is 04:29, then the created TimeOfDay will always have
   * the time 04:29 irrespective of time zone issues.
   * <p>
   ...
   */
  /*
   * public static TimeOfDay fromCalendarFields(Calendar calendar) { if
  ...
  /**
   * Constructs a TimeOfDay from a <code>java.util.Date</code> using exactly the
   * same field values avoiding any time zone effects.
   * <p>
   * Each field is queried from the Date and assigned to the TimeOfDay. This is
   * useful to ensure that the field values are the same in the created
   * TimeOfDay no matter what the time zone is. For example, if the Calendar
   * states that the time is 04:29, then the created TimeOfDay will always have
   * the time 04:29 irrespective of time zone issues.
   * <p>
  ...
  public static TimeOfDay fromDateFields(Date date) {
    ...
    return new TimeOfDay(date.getHours(), date.getMinutes(), date.getSeconds(), (int) (date.getTime() % 1000));
  }
  ...
  /**
   * Constructs a TimeOfDay from the specified millis of day using the specified
   * chronology.
   * <p>
   * The millisOfDay value may exceed the number of millis in one day, but
   * additional days will be ignored. This method uses the UTC time zone
   ...
   * calculations are performed without reference to a timezone (by switching to
   * UTC).
   */
  public TimeOfDay() {
    super();
   ...
   * described by {@link ISODateTimeFormat#timeParser()}.
   * <p>
  ...
  //-----------------------------------------------------------------------
  /**
   * Returns a copy of this time with the specified chronology. This instance is
   * immutable and unaffected by this method call.
   * <p>
   * This method retains the values of the fields, thus the result will
   * typically refer to a different instant.
   * <p>
   * The time zone of the specified chronology is ignored, as TimeOfDay operates
   * without a time zone.
  ...
  public TimeOfDay withChronologyRetainFields(Chronology newChronology) {
    ...
    if (newChronology == getChronology()) {
      ...
      newChronology.valDateTime(newTimeOfDay, getValues());
      return newTimeOfDay;
    }
  }
  ...
  //-----------------------------------------------------------------------
  /**
   * Returns a copy of this time with the specified period taken away, wrapping
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
    ...
    //-----------------------------------------------------------------------
    /**
     * Adds to the value of this field in a copy of this TimeOfDay, wrapping to
     * what would be the next day if necessary.
     * <p>
    ...
    /**
     * Adds to the value of this field in a copy of this TimeOfDay, throwing an
     * Exception if the bounds are exceeded.
     * <p>
     * The value will be added to this field. If the value is too large to be
     * added solely to this field then it will affect larger fields. Smaller
     * fields are unaffected.
     * <p>
     * If the result would be too large (beyond 23:59:59:999) or too small (less
     * than 00:00:00.000) then an Execption is thrown. For the alternate
     * behaviour which wraps to the next 'day', see {@link #addToCopy(int)}.
     * <p>
     * The TimeOfDay attached to this property is unchanged by this call.
     * Instead, a new instance is returned.
     * @param valueToAdd the value to add to the field in the copy
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new TimeOfDay with this field set to the maximum value for this
     * field.
     * <p>
     * The TimeOfDay attached to this property is unchanged by this call.
    ...
    /**
     * Returns a new TimeOfDay with this field set to the minimum value for this
     * field.
     * <p>
     * The TimeOfDay attached to this property is unchanged by this call.
