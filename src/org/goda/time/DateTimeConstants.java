...
/**
 * DateTimeConstants is a non-instantiable class of constants used in the date
 * time system. These are the ISO8601 constants, but should be used by all
 * chronologies.
 * <p>
...
public class DateTimeConstants {
   ...
   * <p>
   * All new chronologies with differrent Era values should try to assign eras
   * as follows. The era that was in force at 1970-01-01 (ISO) is assigned the
   * value 1. Earlier eras are assigned sequentially smaller numbers. Later eras
   * are assigned sequentially greater numbers.
   */
  ...
  /**
   * Minutes in a typical week (ISO). Due to time zone offset changes, the
   * number of minutes per week can vary.
   */
  public static final int MINUTES_PER_WEEK = MINUTES_PER_DAY * DAYS_PER_WEEK;
  /**
   * Seconds in a typical week (ISO). Due to time zone offset changes, the
   * number of seconds per week can vary.
   */
