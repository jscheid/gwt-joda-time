...
public class DateTimeComparator implements Comparator, Serializable {
  ...
  /**
   * Returns a DateTimeComparator with a lower limit only. Fields of a magnitude
   * less than the lower limit are excluded from comparisons.
   * @param lowerLimit inclusive lower limit for fields to be compared, null
   *          means no limit
   ...
   * magnitude less than the lower limit are excluded from comparisons. Fields
   * of a magnitude greater than or equal to the upper limit are also excluded
   * from comparisons. Either limit may be specified as null, which indicates an
   * unbounded limit.
   * @param lowerLimit inclusive lower limit for fields to be compared, null
   *          means no limit
   * @param upperLimit exclusive upper limit for fields to be compared, null
   *          means no limit
  ...
  /**
   * Compare two objects against only the range of date time fields as specified
   * in the constructor.
  ...
  public boolean equals(Object object) {
    if (object instanceof DateTimeComparator) {
      ...
      return (iLowerLimit == other.getLowerLimit() || (iLowerLimit != null && iLowerLimit.equals(other.getLowerLimit())))
          && (iUpperLimit == other.getUpperLimit() || (iUpperLimit != null && iUpperLimit.equals(other.getUpperLimit())));
    }
    return false;
  }
