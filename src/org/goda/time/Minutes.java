...
import org.goda.time.base.BaseSingleFieldPeriod;
import org.goda.time.field.FieldUtils;
import org.goda.time.format.ISOPeriodFormat;
import org.goda.time.format.PeriodFormatter;

/**
 * An immutable time period representing a number of minutes.
 * <p>
 * <code>Minutes</code> is an immutable period that can only store minutes. It
 * does not store years, months or hours for example. As such it is a type-safe
 * way of representing a number of minutes in an application.
 * <p>
...
public final class Minutes extends BaseSingleFieldPeriod {
  ...
  /**
   * Creates a <code>Minutes</code> representing the number of whole minutes in
   ...
   * be converted.
   * @param period the period to get the number of minutes from, null returns
   *          zero
   * @return the period in minutes
  ...
  /**
   * Creates a new <code>Minutes</code> by parsing a string in the ISO8601
   * format 'PTnM'.
   * <p>
   * The parse will accept the full ISO syntax of PnYnMnWnDTnHnMnS however only
   * the minutes component may be non-zero. If any other component is non-zero,
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new instance representing a number of minutes. You should
   * consider using the factory method {@link #minutes(int)} instead of the
   * constructor.
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this period in minutes to a period in weeks assuming a 7 days
   * week, 24 hour day and 60 minute hour.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all weeks are 7 days
   * long, all days are 24 hours long and all hours are 60 minutes long. This is
   * not true when daylight savings is considered and may also not be true for
  ...
  /**
   * Converts this period in minutes to a period in days assuming a 24 hour day
   * and 60 minute hour.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all days are 24 hours
   * long and all hours are 60 minutes long. This is not true when daylight
   * savings is considered and may also not be true for some unusual
   * chronologies. However, it is included as it is a useful operation for many
  ...
  /**
   * Converts this period in minutes to a period in hours assuming a 60 minute
   * hour.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all hours are 60
   * minutes long. This may not be true for some unusual chronologies. However,
   * it is included as it is a useful operation for many applications and
   * business rules.
  ...
  /**
   * Converts this period in minutes to a period in seconds assuming a 60 second
   * minute.
   * <p>
   * This method allows you to convert between different types of period.
   * However to achieve this it makes the assumption that all minutes are 60
   * seconds long. This may not be true for some unusual chronologies. However,
   * it is included as it is a useful operation for many applications and
   * business rules.
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this period in minutes to a duration in milliseconds assuming a 60
   * second minute.
   * <p>
   * This method allows you to convert from a period to a duration. However to
   * achieve this it makes the assumption that all minutes are 60 seconds long.
   * This might not be true for an unusual chronology, for example one that
   * takes leap seconds into account. However, the method is included as it is a
   ...
   * <p>
   * This instance is immutable and unaffected by this method call.
   * @param minutes the amount of minutes to add, may be negative, null means
   *          zero
   * @return the new period plus the specified number of minutes
   * @throws ArithmeticException if the result overflows an int
   */
