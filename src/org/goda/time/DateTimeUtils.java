...
public class DateTimeUtils {
   ...
   * <p>
   * By default this returns <code>System.currentTimeMillis()</code>. This may
   * be changed using other methods in this class.
   ...
   * <p>
   * This method changes the behaviour of {@link #currentTimeMillis()}. Whenever
   * the current time is queried, {@link System#currentTimeMillis()} is used.
   ...
   * <p>
   * This method changes the behaviour of {@link #currentTimeMillis()}. Whenever
   * the current time is queried, the same millisecond time will be returned.
   ...
   * <p>
   * This method changes the behaviour of {@link #currentTimeMillis()}. Whenever
   * the current time is queried, {@link System#currentTimeMillis()} is used and
   * then offset by adding the millisecond value specified here.
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the millisecond instant from the specified instant object handling
   * null.
   * <p>
   * If the instant object is <code>null</code>, the
   * {@link #currentTimeMillis()} will be returned. Otherwise, the millis from
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the chronology from the specified instant based interval handling
   * null.
   * <p>
   ...
   * <p>
   * If the interval object is <code>null</code>, or the interval's chronology
   * is <code>null</code>, {@link ISOChronology#getInstance()} will be returned.
   * Otherwise, the chronology from the object is returned.
   ...
   * <p>
   * If the interval is <code>null</code>, an interval representing now to now
   * in the {@link ISOChronology#getInstance() ISOChronology} will be returned.
   * Otherwise, the interval specified is returned.
   ...
   * <p>
   * If the zone is <code>null</code>, {@link DateTimeZone#getDefault()} will be
   * returned. Otherwise, the zone specified is returned.
   ...
   * <p>
   * If the zone is <code>null</code>, {@link PeriodType#standard()} will be
   * returned. Otherwise, the type specified is returned.
   ...
   * <p>
   * For example <code>LocalDate</code> is contiguous because DayOfMonth has the
   ...
   * MillisOfSecond, SecondOfMinute, MinuteOfHour and HourOfDay (note how the
   * names of each field 'join up').
   * <p>
   * However, a Year/HourOfDay partial is not contiguous because the range field
   * Day is not equal to the next field Year. Similarly, a DayOfWeek/DayOfMonth
   * partial is not contiguous because the range Month is not equal to the next
   * field Day.
