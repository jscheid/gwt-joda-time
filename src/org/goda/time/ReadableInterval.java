 ...
 * <code>null</code> as a zero length interval at the current instant in time.
...
public interface ReadableInterval {
   ...
   * @return the start of the time interval, millisecond instant from
   ...
   * @return the end of the time interval, millisecond instant from
   *         1970-01-01T00:00:00Z
   */
  long getEndMillis();
   ...
   * abut, (b) there is a gap between them, (c) they overlap. The
   * <code>contains</code> method is not related to these states. In particular,
   * a zero duration interval is contained at the start of a larger interval,
  ...
  /**
   * Converts the duration of the interval to a period using the standard period
   * type.
   * <p>
  ...
  /**
   * Converts the duration of the interval to a period using the specified
   * period type.
   * <p>
   * This method should be used to exract the field values describing the
   * difference between the start and end instants.
  ...
  //-----------------------------------------------------------------------
  /**
   * Compares this object with the specified object for equality based on start
   * and end millis plus the chronology. All ReadableInterval instances are
   * accepted.
   * <p>
   * To compare the duration of two time intervals, use {@link #toDuration()} to
   * get the durations and compare those.
  ...
  /**
   * Gets a hash code for the time interval that is compatable with the equals
   * method.
   * <p>
   ...
   * <pre>
   * int result = 97;
   * result = 31 * result + ((int) (getStartMillis() &circ; (getStartMillis() &gt;&gt;&gt; 32)));
   * result = 31 * result + ((int) (getEndMillis() &circ; (getEndMillis() &gt;&gt;&gt; 32)));
