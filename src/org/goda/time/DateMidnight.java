 ...
 * on any given day. Note that midnight is defined as 00:00, which is at the
 * very start of a day.
 * <p>
 ...
 * or a {@link LocalDate} may be more suitable.
 * <p>
 * This class uses a Chronology internally. The Chronology determines how the
 * millisecond instant value is converted into the date time fields. The default
 * Chronology is <code>ISOChronology</code> which is the agreed international
 * standard and compatable with the modern Gregorian calendar.
 * <p>
...
public final class DateMidnight extends BaseDateTime implements ReadableDateTime, Serializable {
   ...
   * <code>ISOChronology</code> in the default time zone. The constructed object
  ...
  /**
   * Constructs an instance set to the current system millisecond time using
   * <code>ISOChronology</code> in the specified time zone. The constructed
   * object will have a local time of midnight.
   * <p>
   ...
   * specified chronology. The constructed object will have a local time of
   * midnight.
   * <p>
   ...
   * using <code>ISOChronology</code> in the default time zone. The constructed
   * object will have a local time of midnight.
  ...
  /**
   * Constructs an instance set to the milliseconds from 1970-01-01T00:00:00Z
   * using the specified chronology. The constructed object will have a local
   * time of midnight.
   * <p>
   * If the chronology is null, <code>ISOChronology</code> in the default time
   * zone is used.
   ...
   * the time zone to that specified. The constructed object will have a local
   * time of midnight.
   * <p>
   * If the object implies a chronology (such as GregorianCalendar does), then
  ...
  //-----------------------------------------------------------------------
  /**
   * Returns a copy of this date with a different millisecond instant. The
   * returned object will have a local time of midnight.
   * <p>
   * Only the millis will change, the chronology and time zone are kept. The
   ...
   * (When its midnight in London its the same day in Paris, but when its
   * midnight in Paris its still the previous day in London)
   * <p>
   * To avoid these unusual effects, use
   * {@link #withZoneRetainFields(DateTimeZone)} to change time zones.
   ...
   * from this instance.
   * <p>
   * For example, if the partial is a <code>LocalDate</code> then the date
   ...
   * month field would be changed in the returned instance. If the field type is
  ...
  //-----------------------------------------------------------------------
  /**
   * Converts this object to a <code>YearMonthDay</code> using the same date and
   * chronology.
  ...
  /**
   * Converts this object to an <code>Interval</code> encompassing the whole of
   * this day.
   * <p>
   ...
   * <p>
   * DateMidnight is immutable, so there are no set methods. Instead, this
   ...
   * instances of DateMidnight - they do not modify the original. The example
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
     ...
     * This operation is faster than converting a DateMidnight to a
    ...
    /**
     * Adds to this field, possibly wrapped, in a copy of this DateMidnight. A
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new DateMidnight with this field set to the maximum value for
     * this field.
     * <p>
    ...
    /**
     * Returns a new DateMidnight with this field set to the minimum value for
     * this field.
     * <p>
     * The DateMidnight attached to this property is unchanged by this call.
     ...
     * DateMidnight, favoring the floor if halfway.
     * @return a copy of the DateMidnight with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this
     * DateMidnight, favoring the ceiling if halfway.
     * @return a copy of the DateMidnight with the field value changed
     */
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this
     * DateMidnight. If halfway, the ceiling is favored over the floor only if
