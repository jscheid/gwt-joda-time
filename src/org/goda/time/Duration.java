 ...
 * of fields, such as days or seconds, as these fields can vary in length. A
 * duration may be converted to a {@link Period} to obtain field values. This
 * conversion will typically cause a loss of precision however.
 * <p>
...
public final class Duration extends BaseDuration implements ReadableDuration, Serializable {
  ...
  //-----------------------------------------------------------------------
  /**
   * Get this duration as an immutable <code>Duration</code> object by returning
   * <code>this</code>.
  ...
  /**
   * Returns a new duration with this length minus that specified. This instance
   * is immutable and is not altered.
   * <p>
   * If the addition is zero, this instance is returned.
  ...
  /**
   * Gets the length of this duration in seconds assuming 1000 milliseconds in a
   * second.
   * <p>
  ...
  /**
   * Converts this duration to a period in seconds assuming 1000 milliseconds in
   * a second.
   * <p>
  ...
  /**
   * Create a duration with the specified number of days assuming that there are
   * the standard number of milliseconds in a day.
   * <p>
   ...
   * <p>
   * A Duration is a representation of an amount of time. If you want to express
   * the concepts of 'minutes' you should consider using the {@link Minutes}
   * class.
   ...
   * <p>
   * A Duration is a representation of an amount of time. If you want to express
   * the concepts of 'seconds' you should consider using the {@link Seconds}
   * class.
