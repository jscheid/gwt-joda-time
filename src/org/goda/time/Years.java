 ...
 * <p>
 * <code>Years</code> is an immutable period that can only store years. It does
 * not store years, days or hours for example. As such it is a type-safe way of
 * representing a number of years in an application.
 * <p>
...
public final class Years extends BaseSingleFieldPeriod {
  ...
  /**
   * Constant representing the maximum number of years that can be stored in
   * this object.
   */
  public static final Years MAX_VALUE = new Years(Integer.MAX_VALUE);
  /**
   * Constant representing the minimum number of years that can be stored in
   * this object.
   */
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a <code>Years</code> representing the number of whole years between
  ...
  /**
   * Creates a <code>Years</code> representing the number of whole years in the
   ...
   * the years component may be non-zero. If any other component is non-zero, an
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a new instance representing a number of years. You should consider
   * using the factory method {@link #years(int)} instead of the constructor.
  ...
  /**
   * Returns a new instance with the years divided by the specified divisor. The
