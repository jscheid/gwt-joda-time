...
public class PeriodFormatter {
   ...
   * <p>
   * A PeriodFormatter is immutable, so a new instance is returned, and the
   ...
   * @return new position, if negative, parse failed. Apply complement operator
   *         (~) to get position of failure
