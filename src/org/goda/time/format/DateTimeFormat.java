 ...
 * K       hour of halfday (0&tilde;11)       number        0
 * h       clockhour of halfday (1&tilde;12)  number        12
 * 
 * H       hour of day (0&tilde;23)           number        0
 * k       clockhour of day (1&tilde;24)      number        24
...
public class DateTimeFormat {
   ...
   * change the locale of the formatter. Call
   ...
   * <p>
   * The first character is the date style, and the second character is the time
   * style. Specify a character of 'S' for short style, 'M' for medium, 'L' for
   * long, and 'F' for full. A date or time may be ommitted by specifying a
   * style character '-'.
   * <p>
  ...
  /**
   * Select a format from a two character style pattern. The first character is
   * the date style, and the second character is the time style. Specify a
  ...
  static class StyleFormatter implements DateTimePrinter, DateTimeParser {
    ...
    private final int DateTimeStyle;
     ...
     * IOException { DateTimePrinter p = getFormatter(locale).getPrinter();
     ...
     * throws IOException { DateTimePrinter p =
     * getFormatter(locale).getPrinter(); p.printTo(out, partial, locale); }
     */
    ...
    private DateTimeFormatter getFormatter(Locale locale) {
      ...
      String key = Integer.toString(iType + (DateTimeStyle << 4) + (iTimeStyle << 8)) + locale.toString();
      DateTimeFormatter f = null;
      synchronized (cCache) {
