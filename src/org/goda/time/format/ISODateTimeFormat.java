...
public class ISODateTimeFormat {
  ...
  //-----------------------------------------------------------------------
  private static DateTimeFormatter ye, // year element (yyyy)
   ...
   * thus in the example, the calendar style is chosen as dayOfMonth is higher
   * in priority than dayOfWeek:
   * <ul>
   ...
   * </pre>
   * 
   ** indiates that this is not an official ISO format and can be excluded by
   * passing in <code>strictISO</code> as <code>true</code>.
   * @param fields the fields to get a formatter for, not null, updated by the
   *          method call, which removes those fields built in the formatter
  ...
  //-----------------------------------------------------------------------
  /**
   * Creates a date using the ordinal date format. Specification reference:
   * 5.2.2.
   * @param bld the builder
   * @param fields the fields
   * @param extended true to use extended format
   ...
   * @since 1.1
   */
  private static void time(DateTimeFormatterBuilder bld, Collection<DateTimeFieldType> fields, boolean extended, boolean strictISO, boolean reducedPrec,
      boolean datePresent) {
  ...
  public static DateTimeFormatter dateParser() {
    if (dp == null) {
      ...
      dp = new DateTimeFormatterBuilder().append(dateElementParser()).appendOptional(tOffset).toFormatter();
    }
    return dp;
  }

  /**
   * Returns a generic ISO date parser for parsing local dates. This parser is
   * initialised with the local (UTC) time zone.
   * <p>
   * It accepts formats described by the following syntax:
   * 
   * <pre>
  ...
  /**
   * Returns a generic ISO date parser for parsing dates. It accepts formats
  ...
  public static DateTimeFormatter dateElementParser() {
    if (dpe == null) {
      dpe = new DateTimeFormatterBuilder().append(
          null,
          new DateTimeParser[] {
              new DateTimeFormatterBuilder().append(yearElement()).appendOptional(
                  new DateTimeFormatterBuilder().append(monthElement()).appendOptional(dayOfMonthElement().getParser()).toParser()).toParser(),
              ...
              new DateTimeFormatterBuilder().append(yearElement()).append(dayOfYearElement()).toParser()}).toFormatter();
    }
    return dpe;
  }
  ...
  public static DateTimeFormatter timeParser() {
    if (tp == null) {
      tp = new DateTimeFormatterBuilder().appendOptional(literalTElement().getParser()).append(timeElementParser()).appendOptional(
  ...
  /**
   * Returns a generic ISO time parser for parsing local times. This parser is
   * initialised with the local (UTC) time zone.
   * <p>
   * It accepts formats described by the following syntax:
   * 
  ...
  public static DateTimeFormatter localTimeParser() {
    if (ltp == null) {
      ltp = new DateTimeFormatterBuilder().appendOptional(literalTElement().getParser()).append(timeElementParser()).toFormatter().withZone(
          DateTimeZone.UTC);
    }
    return ltp;
  }
  ...
  /**
   * Returns a generic ISO time parser. It accepts formats described by the
   * following syntax:
   * 
   * <pre>
   * time-element   = HH [minute-element] | [fraction]
  ...
  public static DateTimeFormatter timeElementParser() {
    if (tpe == null) {
      ...
      DateTimeParser decimalPoint = new DateTimeFormatterBuilder().append(
          null,
          new DateTimeParser[] {
              new DateTimeFormatterBuilder().appendLiteral('.').toParser(), new DateTimeFormatterBuilder().appendLiteral(',').toParser()}).toParser();
      ...
      // second fraction
      .appendOptional(new DateTimeFormatterBuilder().append(decimalPoint).appendFractionOfSecond(1, 9).toParser()).toParser(),
      // minute fraction
      new DateTimeFormatterBuilder().append(decimalPoint).appendFractionOfMinute(1, 9).toParser(), null}).toParser(),
      // hour fraction
      new DateTimeFormatterBuilder().append(decimalPoint).appendFractionOfHour(1, 9).toParser(), null}).toFormatter();
    }
    return tpe;
  }

  /**
   * Returns a generic ISO datetime parser which parses either a date or a time
   * or both. It accepts formats described by the following syntax:
   * 
   * <pre>
  ...
  public static DateTimeFormatter dateTimeParser() {
    if (dtp == null) {
      ...
      // is required.
      DateTimeParser time = new DateTimeFormatterBuilder().appendLiteral('T').append(timeElementParser()).appendOptional(
          offsetElement().getParser()).toParser();
      dtp = new DateTimeFormatterBuilder().append(null, new DateTimeParser[] {time, dateOptionalTimeParser().getParser()}).toFormatter();
    }
    return dtp;
  }
   ...
   * time is optional. This parser can parse zoned datetimes. It accepts formats
   * described by the following syntax:
   * 
   * <pre>
   * date-opt-time     = date-element ['T' [time-element] [offset]]
  ...
  public static DateTimeFormatter dateOptionalTimeParser() {
    if (dotp == null) {
      DateTimeParser timeOrOffset = new DateTimeFormatterBuilder().appendLiteral('T').appendOptional(timeElementParser().getParser()).appendOptional(
          offsetElement().getParser()).toParser();
      dotp = new DateTimeFormatterBuilder().append(dateElementParser()).appendOptional(timeOrOffset).toFormatter();
    }
    return dotp;
  }
  ...
  /**
   * Returns a generic ISO datetime parser where the date is mandatory and the
   * time is optional. This parser only parses local datetimes. This parser is
   * initialised with the local (UTC) time zone.
   * <p>
   * It accepts formats described by the following syntax:
   * 
  ...
  public static DateTimeFormatter localDateOptionalTimeParser() {
    if (ldotp == null) {
      ...
      ldotp = new DateTimeFormatterBuilder().append(dateElementParser()).appendOptional(time).toFormatter().withZone(DateTimeZone.UTC);
    }
    return ldotp;
  }
   ...
   * offset (HH:mm:ss.SSSZ). The time zone offset is 'Z' for zero, and of the
   * form '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a formatter for a two digit hour of day, two digit minute of hour,
   * two digit second of minute, and time zone offset (HH:mm:ssZ). The time zone
   * offset is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
   ...
   * Returns a formatter for a two digit hour of day, two digit minute of hour,
   * two digit second of minute, three digit fraction of second, and time zone
   * offset prefixed by 'T' ('T'HH:mm:ss.SSSZ). The time zone offset is 'Z' for
   * zero, and of the form '\u00b1HH:mm' for non-zero.
   ...
   * ('T'HH:mm:ssZ). The time zone offset is 'Z' for zero, and of the form
   * '\u00b1HH:mm' for non-zero.
   ...
   * (yyyy-MM-dd'T'HH:mm:ss.SSSZ). The time zone offset is 'Z' for zero, and of
   * the form '\u00b1HH:mm' for non-zero.
   ...
   * separated by a 'T' (yyyy-MM-dd'T'HH:mm:ssZ). The time zone offset is 'Z'
   * for zero, and of the form '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a formatter for a full ordinal date and time, using a four digit
   * year and three digit dayOfYear (yyyy-DDD'T'HH:mm:ss.SSSZ). The time zone
   * offset is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a formatter for a full ordinal date and time without millis, using
   * a four digit year and three digit dayOfYear (yyyy-DDD'T'HH:mm:ssZ). The
   * time zone offset is 'Z' for zero, and of the form '\u00b1HH:mm' for
   * non-zero.
  ...
  /**
   * Returns a formatter for a full date as four digit weekyear, two digit week
   * of weekyear, and one digit day of week (xxxx-'W'ww-e).
  ...
  /**
   * Returns a formatter that combines a full weekyear date and time, separated
   * by a 'T' (xxxx-'W'ww-e'T'HH:mm:ss.SSSZ). The time zone offset is 'Z' for
   * zero, and of the form '\u00b1HH:mm' for non-zero.
   ...
   * millis, separated by a 'T' (xxxx-'W'ww-e'T'HH:mm:ssZ). The time zone offset
   * is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
   ...
   * (HHmmss.SSSZ). The time zone offset is 'Z' for zero, and of the form
   * '\u00b1HH:mm' for non-zero.
   * @return a formatter for HHmmss.SSSZ
   */
  public static DateTimeFormatter basicTime() {
    if (bt == null) {
      bt = new DateTimeFormatterBuilder().appendHourOfDay(2).appendMinuteOfHour(2).appendSecondOfMinute(2).appendLiteral('.').appendMillisOfSecond(
          3).appendTimeZoneOffset("Z", false, 2, 2).toFormatter();
    }
    return bt;
  }
  ...
  /**
   * Returns a basic formatter for a two digit hour of day, two digit minute of
   * hour, two digit second of minute, and time zone offset (HHmmssZ). The time
   * zone offset is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
   * @return a formatter for HHmmssZ
   */
  public static DateTimeFormatter basicTimeNoMillis() {
    if (btx == null) {
      btx = new DateTimeFormatterBuilder().appendHourOfDay(2).appendMinuteOfHour(2).appendSecondOfMinute(2).appendTimeZoneOffset("Z",
          false, 2, 2).toFormatter();
    }
    return btx;
  }
   ...
   * Returns a basic formatter for a two digit hour of day, two digit minute of
   * hour, two digit second of minute, three digit millis, and time zone offset
   * prefixed by 'T' ('T'HHmmss.SSSZ). The time zone offset is 'Z' for zero, and
   ...
   * ('T'HHmmssZ). The time zone offset is 'Z' for zero, and of the form
   * '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a basic formatter that combines a basic date and time, separated by
   * a 'T' (yyyyMMdd'T'HHmmss.SSSZ). The time zone offset is 'Z' for zero, and
   * of the form '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a basic formatter that combines a basic date and time without
   * millis, separated by a 'T' (yyyyMMdd'T'HHmmssZ). The time zone offset is
  ...
  /**
   * Returns a formatter for a full ordinal date and time, using a four digit
   * year and three digit dayOfYear (yyyyDDD'T'HHmmss.SSSZ). The time zone
   * offset is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a formatter for a full ordinal date and time without millis, using
   * a four digit year and three digit dayOfYear (yyyyDDD'T'HHmmssZ). The time
   * zone offset is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
   ...
   * separated by a 'T' (xxxx'W'wwe'T'HHmmss.SSSZ). The time zone offset is 'Z'
   * for zero, and of the form '\u00b1HH:mm' for non-zero.
  ...
  /**
   * Returns a basic formatter that combines a basic weekyear date and time
   * without millis, separated by a 'T' (xxxx'W'wwe'T'HHmmssZ). The time zone
   * offset is 'Z' for zero, and of the form '\u00b1HH:mm' for non-zero.
  ...
  public static DateTimeFormatter hourMinuteSecondMillis() {
    if (hmsl == null) {
      hmsl = new DateTimeFormatterBuilder().append(hourElement()).append(minuteElement()).append(secondElement()).append(millisElement()).toFormatter();
    }
    return hmsl;
  }
  ...
  /**
   * Returns a formatter that combines a full date, two digit hour of day, and
   * two digit minute of hour. (yyyy-MM-dd'T'HH:mm)
   ...
   * digit minute of hour, and two digit second of minute.
  ...
  /**
   * Returns a formatter that combines a full date, two digit hour of day, two
   * digit minute of hour, two digit second of minute, and three digit fraction
   * of second. (yyyy-MM-dd'T'HH:mm:ss.SSS)
  ...
  private static DateTimeFormatter fractionElement() {
    if (fse == null) {
      fse = new DateTimeFormatterBuilder().appendLiteral('.')
