 ...
 * <p>
 * Application users will rarely use this class directly. Instead, you will use
 * one of the factory classes to create a {@link DateTimeFormatter}.
 * <p>
...
public interface DateTimeParser extends DateTimePrinterParser {
   ...
   * text.
   * <p>
   * If it fails, the return value is negative. To determine the position where
   * the parse failed, apply the one's complement operator (~) on the return
   * value.
