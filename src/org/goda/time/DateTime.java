...
public final class DateTime extends BaseDateTime implements ReadableDateTime, Serializable {
  ...
  /**
   * Constructs an instance set to the current system millisecond time using the
   ...
   * ReadableInstant, String, Calendar and Date. The String formats are
   * described by {@link ISODateTimeFormat#dateTimeParser()}.
   ...
   * ISO is used in the specified time zone. If the specified time zone is null,
   * the default zone is used. Thus if a GregorianCalendar is passed in, the
   * chronology used will be GJ, but if a Date is passed in the chronology will
   * be ISO.
   * <p>
   * The recognised object types are defined in
   * {@link org.joda.time.convert.ConverterManager ConverterManager} and include
   ...
   * example, if this instant holds 12:30 in Europe/London, the result from this
   * method with Europe/Paris would be 13:30.
   * <p>
   * The returned object will be a new instance of the same implementation type.
   * This method changes the time zone, and does not change the millisecond
   * instant, with the effect that the field values usually change. The returned
   * object will be either be a new instance or <code>this</code>.
   ...
   * For example, if this instant holds 12:30 in Europe/London (ie. 12:30Z), the
   * result from this method with Europe/Paris would be 12:30 (ie. 11:30Z).
   * <p>
   * The returned object will be a new instance of the same implementation type.
   * This method changes the time zone and the millisecond instant to keep the
   * field values the same. The returned object will be either be a new instance
   * or <code>this</code>.
   ...
   * Returns a copy of this datetime with the specified period added.
   * <p>
   * This method will add each element of the period one by one, from largest to
   * smallest, adjusting the datetime to be accurate between each.
   * <p>
   ...
   * cannot result in 2009-02-29, so the day of month is adjusted to 2009-02-28.
   * <p>
   ...
   * cannot result in 2007-04-31, so the day of month is adjusted to 2007-04-30.
   * <p>
   * The following three lines are identical in effect:
   * 
   * <pre>
   ...
   * <p>
   * The calculation will do its best to only change the day field retaining the
   * same time of day. However, in certain circumstances, typically daylight
   * savings cutover, it may be necessary to alter the time fields.
   * <p>
   * In spring an hour is typically removed. If adding one day results in the
   * time being within the cutover then the time is adjusted to be within summer
   * time. For example, if the cutover is from 01:59 to 03:00 and the result of
   * this method would have been 02:30, then the result will be adjusted to
   * 03:30.
   * <p>
   * The following three lines are identical in effect:
   * 
   ...
   * 2007-04-30 Then subtract one day and adjust, resulting in 2007-04-29. Note
   * that the day has been adjusted by two.
   * <p>
   ...
   * cannot result in 2007-02-29, so the day of month is adjusted to 2007-02-28.
   * <p>
   * The following three lines are identical in effect:
   * 
   * <pre>
   ...
   * The calculation will do its best to only change the month field retaining
   * the same day of month. However, in certain circumstances, it may be
   * necessary to alter smaller fields. For example, 2007-05-31 minus one month
   * cannot result in 2007-04-31, so the day of month is adjusted to 2007-04-30.
   * <p>
   * The following three lines are identical in effect:
   * 
   ...
   * <p>
   * The calculation will subtract a duration equivalent to the number of hours
   * expressed in milliseconds.
   * <p>
   * For example, if a spring daylight savings cutover is from 01:59 to 03:00
   * then subtracting one hour from 03:30 will result in 01:30. This is a
   * duration of one hour earlier, even though the hour field value changed from
   * 3 to 1.
   * <p>
   * The following three lines are identical in effect:
   * 
  ...
  /**
   * Converts this object to a <code>TimeOfDay</code> using the same millis and
   * chronology.
  ...
  /**
   * Converts this object to a <code>LocalDateTime</code> with the same datetime
   * and chronology.
   ...
   * instances of DateTime - they do not modify the original. The example below
  ...
  public static final class Property extends AbstractReadableInstantFieldProperty {
     ...
     * <p>
     * The DateTime attached to this property is unchanged by this call. This
     * operation is faster than converting a DateTime to a MutableDateTime and
     * back again when setting one field. When setting multiple fields, it is
     * generally quicker to make the conversion to MutableDateTime.
     ...
     * wrapped operation only changes this field. Thus 31st January addWrapField
     * one day goes to the 1st January.
     * <p>
     * The DateTime attached to this property is unchanged by this call. This
     * operation is faster than converting a DateTime to a MutableDateTime and
     * back again when setting one field. When setting multiple fields, it is
    ...
    //-----------------------------------------------------------------------
    /**
     * Returns a new DateTime with this field set to the maximum value for this
     * field.
     * <p>
     * This operation is useful for obtaining a DateTime on the last day of the
    ...
    /**
     * Returns a new DateTime with this field set to the minimum value for this
     * field.
     * <p>
     * The DateTime attached to this property is unchanged by this call.
    ...
    /**
     * Rounds to the nearest whole unit of this field on a copy of this
     * DateTime. If halfway, the ceiling is favored over the floor only if it
