...
/**
 * Defines a time period specified in terms of individual duration fields such
 * as years and days.
 * <p>
 ...
 * fields. The value for each field may be positive or negative.
 * <p>
 * When a time period is added to an instant, the effect is to add each field in
 * turn. For example, a time period could be defined as 3 months, 2 days and -1
 * hours. In most circumstances this would be the same as 3 months, 1 day, and
 * 23 hours. However, when adding across a daylight savings boundary, a day may
 * be 23 or 25 hours long. Thus, the time period is always added field by field
 * to the datetime.
 * <p>
...
public interface ReadablePeriod {
   ...
   * value and type of each supported field. All ReadablePeriod instances are
   * accepted.
   * <p>
   ...
   * {@link Duration}s, an operation that emphasises that the result may differ
   * according to the date you choose.
   * @param readablePeriod a readable period to check against
   * @return true if all the field values and types are equal, false if not or
   *         the period is null or of an incorrect type
   */
