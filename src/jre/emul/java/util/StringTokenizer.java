 ...
 * blocks of characters that do not contain a delimiter. If returnDelimiters is
 * true, delimiters are considered to be tokens, and successive calls to
 * nextToken() return either a one character delimiter, or a maximal block of
